...
public class PhoneCallOptionHandlerExtensionContainer extends PhoneCallOptionHandlerExtension {

    private static final String LOG_TAG = "PhoneCallOptionHandlerExtensionContainer";

    private LinkedList<PhoneCallOptionHandlerExtension> mSubExtensionList;

    /**
     * @param extension
     */
    public void add(PhoneCallOptionHandlerExtension extension) {
        if (null == mSubExtensionList) {
            log("create sub extension list");
            mSubExtensionList = new LinkedList<PhoneCallOptionHandlerExtension>();
        }
     ...
     * @param extension 
     */
    public void remove(PhoneCallOptionHandlerExtension extension) {
        if (null == mSubExtensionList) {
    ...
    public boolean doCallOptionHandle(LinkedList<CallOptionBaseHandler> callOptionHandlerList,
        ...
        Iterator<PhoneCallOptionHandlerExtension> iterator = mSubExtensionList.iterator();
        while (iterator.hasNext()) {
            PhoneCallOptionHandlerExtension extension = iterator.next();
