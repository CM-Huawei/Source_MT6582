...
public class PhoneAppBroadcastReceiverExtensionContainer
             extends PhoneAppBroadcastReceiverExtension {

    private static final String LOG_TAG = "PhoneAppBroadcastReceiverExtensionContainer";

    private LinkedList<PhoneAppBroadcastReceiverExtension> mSubExtensionList;

    /**
     * @param extension
     */
    public void add(PhoneAppBroadcastReceiverExtension extension) {
        if (null == mSubExtensionList) {
            log("create sub extension list");
            mSubExtensionList = new LinkedList<PhoneAppBroadcastReceiverExtension>();
        }
     ...
     * @param extension 
     */
    public void remove(PhoneAppBroadcastReceiverExtension extension) {
        if (null == mSubExtensionList) {
    ...
    public boolean onReceive(Context context, Intent intent) {
        ...
        Iterator<PhoneAppBroadcastReceiverExtension> iterator
                = mSubExtensionList.iterator();
        while (iterator.hasNext()) {
            PhoneAppBroadcastReceiverExtension extension = iterator.next();
