...
public class SipSharedPreferences {
    ...
    public String getSipCallOption() {
        String option = Settings.Global.getString(mContext.getContentResolver(),
    ...
    public boolean getReceivingCallsEnabled() {
        int enable = 0;
        try {
            enable = Settings.Global.getInt(mContext.getContentResolver(), Settings.System.SIP_RECEIVE_CALLS);
