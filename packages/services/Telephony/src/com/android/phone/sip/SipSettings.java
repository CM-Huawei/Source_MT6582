...
public class SipSettings extends PreferenceActivity {
    ...
    public void onResume() {
        ...
        Log.d(TAG, "onResume: finish update the list, callManager Idle = " + mCallManager.getState());
        ...
        /// M: for ALPS00597970 @{
        // need to refresh the options menu
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        Log.d(TAG, "onPrepareOptionsMenu, callManager Idle = " + mCallManager.getState());
        menu.findItem(MENU_ADD_ACCOUNT).setEnabled(mCallManager.getState() == PhoneConstants.State.IDLE);
