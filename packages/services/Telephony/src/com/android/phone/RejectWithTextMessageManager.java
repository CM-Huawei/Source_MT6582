...
public class RejectWithTextMessageManager {
    ...
    public static void rejectCallWithMessage(String phoneNumber, String message, int slot) {
    /// @}
        if (message != null) {
    ...
    private static int getSendTextSlotId() {
        int slotId = 0;
