...
public class SimContacts extends ADNList {
    ...
    private class ImportAllSimContactsThread extends Thread
        ...
        public void run() {
            ...
            while (!mCanceled && mCursor.moveToNext()) {
                ...
                /// M:bug fix ALPS00406557, the Activity may be destroyed @{
            ...
            if (mProgressDialog != null && mProgressDialog.isShowing()) {
                Log.d(LOG_TAG, "Dismiss progressDialog after import all simContacts");
                /// @}
    ...
    /// M:bug fix ALPS00406557 @{
    // if SimContacts is destroyed, dismiss its dialog
    @Override
    protected void onDestroy() {
        if (mProgressDialog != null && mProgressDialog.isShowing()) {
            Log.d(LOG_TAG, "onDestroy - dismiss progressDialog");
            mProgressDialog.dismiss();
            mProgressDialog = null;
        }
        super.onDestroy();
