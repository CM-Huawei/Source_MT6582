...
public class CdmaOptions {
    ...
    ///M: for adjust setting UI on VXGA device.
    public CdmaOptions(PreferenceFragment fragment, PreferenceScreen prefScreen, Phone phone) {
        mPrefFragment = fragment;
    ...
    protected void create() {
        ...
        final boolean voiceCapable = mPrefFragment.getResources().getBoolean(
