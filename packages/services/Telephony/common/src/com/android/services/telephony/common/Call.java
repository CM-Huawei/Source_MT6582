...
public final class Call implements Parcelable {
    ...
    public static class Capabilities {
        ...
        /// M: For more capabilities. @{
        public static final int RECORD             = 0x00000100; /* Recording */
        public static final int HANGUP_ALL         = 0x00000200; /* Recording */
        public static final int HANGUP_HOLDING     = 0x00000400; /* Recording */
        public static final int HANGUP_ACTIVE_AND_ANSWER_WAITING = 0x00000800; /* Recording */
        public static final int ECT                = 0x00001000; /* Recording */
        public static final int VT_VOICE_ANSWER    = 0x00002000; /* Recording */
        public static final int SHOW_SWAP          = 0x00004000; /* Dualtalk */

        public static final int ALL = HOLD | SUPPORT_HOLD | MERGE_CALLS | SWAP_CALLS | ADD_CALL
                | RESPOND_VIA_TEXT | MUTE | GENERIC_CONFERENCE | RECORD | HANGUP_ALL
                | HANGUP_HOLDING | HANGUP_ACTIVE_AND_ANSWER_WAITING | ECT | VT_VOICE_ANSWER | SHOW_SWAP;
        // / @}
    }
    ...
    public enum DisconnectCause {
        ...
        INVALID_NUMBER_FORMAT,          /*below disconnect causes are for VT drop back feature*/
    ...
    public Call(Call call) {
        ...
        // Show reject message to user.
        mRejectMessage = call.mRejectMessage;
        // Add for Dualtalk.
        mPhoneType = call.mPhoneType;
        mPhoneId = call.mPhoneId;
        /// @}
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        /// M: Add for MTK Feature. @{
        // Show reject message to user.
        dest.writeString(mRejectMessage);
        // Add for Dualtalk.
        dest.writeInt(mPhoneType);
    ...
    public String toString() {
        return Objects.toStringHelper(this)
                ...
                /// M: Add for MTK Feature. @{
                // Show reject message to user.
                .add("mRejectMessage", mRejectMessage)
                // Add to Dualtalk.
                .add("mPhoneType", mPhoneType)
                .add("mPhoneId", mPhoneId)
                /// @}
                .toString();
    }
     ...
     * 0 - Voice Call
     */
    public final static int CALL_TYPE_VOICE = 0;
    /**
     * 1 - Video Call
     */
    public final static int CALL_TYPE_VIDEO = 1;

    /**
     * 2 - Sip Call
     */
    public final static int CALL_TYPE_SIP = 2;


    // Add to show reject message to user.
    private String mRejectMessage = null;

    // Add to for Dualtalk.
    private int mPhoneType = PhoneConstants.PHONE_TYPE_NONE;

    // to indicate whether two calls are belonging to same phone.
    private int mPhoneId = 0;

    public boolean isVideoCall() {
        return this.mIdentification.isVideoCall();
    }

    public boolean isIncoming() {
        return this.mIdentification.isIncoming();
    }

    public void setIsIncomingFlag(boolean isIncoming) {
        this.mIdentification.setIsIncomingFlag(isIncoming);
    }

    public void setCallType(int callType) {
        this.mIdentification.setCallType(callType);
    }

    public int getCallType(){
        return this.mIdentification.getCallType();
    }

    public int getSlotId() {
        return this.mIdentification.getSlotId();
    }

    public void setSlotId(int slotId) {
        this.mIdentification.setSlotId(slotId);
    }

    /**
     * M: just for debugging, get the mState text
     * @return might be null
     */
    public String getStateText() {
        return STATE_MAP.get(mState);
    }

    public void setRejectCallNotifyMsg(String message) {
        mRejectMessage = message;
    }

    public String getRejectCallNotifyMsg() {
