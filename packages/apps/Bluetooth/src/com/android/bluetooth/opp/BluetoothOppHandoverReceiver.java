...
public class BluetoothOppHandoverReceiver extends BroadcastReceiver {
    public static final String TAG ="[Bluetooth.OPP]BluetoothOppHandoverReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(V)Log.v(TAG, "onReceiver::action = " + action);
        ...
        if (action.equals(Constants.ACTION_HANDOVER_SEND) ||
            ...
            if (action.equals(Constants.ACTION_HANDOVER_SEND)) {
                ...
                if (stream != null && type != null) {
                    ...
                    // session to DB.
                    if (D) Log.d(TAG, "stream = " + stream.toString() + " type = " +  type);
