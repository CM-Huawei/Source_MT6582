 ...
 */
public class BluetoothPbapVCardBuilder extends VCardBuilder {
    private static final String LOG_TAG = "BluetoothPbapVCardBuilder";
    ...
    private static final boolean mUsePbapNameImprove = true;
    ...
    //some constants copy from VCardConstants.java
    private static final String PARAM_TYPE_X_IRMC_N = "X-IRMC-N";
    static final int MAX_CHARACTER_NUMS_BASE64_V30 = 75;

    public BluetoothPbapVCardBuilder(final int vcardType) {
     ...
     */
    public BluetoothPbapVCardBuilder(final int vcardType, String charset) {
     ...
     */
    private BluetoothPbapVCardBuilder appendNamePropertiesV40(final List<ContentValues> contentValuesList) {
     ...
     * vCard spec.
     */
    public BluetoothPbapVCardBuilder appendNameProperties(final List<ContentValues> contentValuesList) {
        if (VCardConfig.isVersion40(mVCardType)) {
        ...
        if (!TextUtils.isEmpty(familyName) || !TextUtils.isEmpty(givenName)) {
            ...
            mBuilder.append(VCardConstants.PROPERTY_N);
            if (mUsePbapNameImprove && !TextUtils.isEmpty(displayName)) {
                final String encodedDisplayName;
                if (shouldAppendCharsetParam(displayName)) {
                    mBuilder.append(VCARD_PARAM_SEPARATOR);
                    mBuilder.append(mVCardCharsetParameter);
                }
                if (!mRefrainsQPToNameProperties &&
    ...
    private void appendPhoneticNameFields(final ContentValues contentValues) {
        ...
        if (TextUtils.isEmpty(phoneticFamilyName)
            ...
            if (mIsDoCoMo) {
                ...
                mBuilder.append(VCARD_PARAM_SEPARATOR);
                mBuilder.append(PARAM_TYPE_X_IRMC_N);
                mBuilder.append(VCARD_DATA_SEPARATOR);
                mBuilder.append(VCARD_ITEM_SEPARATOR);
                mBuilder.append(VCARD_ITEM_SEPARATOR);
                mBuilder.append(VCARD_ITEM_SEPARATOR);
    ...
    public BluetoothPbapVCardBuilder appendNickNames(final List<ContentValues> contentValuesList) {
    ...
    public BluetoothPbapVCardBuilder appendPhones(final List<ContentValues> contentValuesList,
            ...
            for (ContentValues contentValues : contentValuesList) {
                ...
                if (translationCallback != null) {
                    ...
                    if (!phoneSet.contains(phoneNumber)) {
                        ...
                        (mVCardType & VCardConfig.FLAG_REFRAIN_PHONE_NUMBER_FORMATTING) != 0) {
...
//                                        digitsOnlyBuilder.toString(), phoneFormat);
    ...
    public BluetoothPbapVCardBuilder appendEmails(final List<ContentValues> contentValuesList) {
    ...
    public BluetoothPbapVCardBuilder appendPostals(final List<ContentValues> contentValuesList) {
        if (contentValuesList == null || contentValuesList.isEmpty()) {
            if (mIsDoCoMo) {
...
//            }
    ...
    public BluetoothPbapVCardBuilder appendIms(final List<ContentValues> contentValuesList) {
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
    ...
    public BluetoothPbapVCardBuilder appendWebsites(final List<ContentValues> contentValuesList) {
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
    ...
    public BluetoothPbapVCardBuilder appendOrganizations(final List<ContentValues> contentValuesList) {
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
    ...
    public BluetoothPbapVCardBuilder appendPhotos(final List<ContentValues> contentValuesList) {
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
                if (contentValues == null) {
                    continue;
    ...
    public BluetoothPbapVCardBuilder appendNotes(final List<ContentValues> contentValuesList) {
        if (contentValuesList != null) {
    ...
    public BluetoothPbapVCardBuilder appendEvents(final List<ContentValues> contentValuesList) {
    ...
    public BluetoothPbapVCardBuilder appendRelation(final List<ContentValues> contentValuesList) {
    ...
    public void appendPhotoLine(final String encodedValue, final String photoType) {
        ...
        final int maxNumForFirstLine = MAX_CHARACTER_NUMS_BASE64_V30
     ...
     */
    public BluetoothPbapVCardBuilder appendSipAddresses(final List<ContentValues> contentValuesList) {
