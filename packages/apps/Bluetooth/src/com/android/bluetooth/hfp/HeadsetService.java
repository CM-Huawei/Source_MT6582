...
public class HeadsetService extends ProfileService {
    ...
    boolean disconnectAudio() {
        ...
        ///   When invoking binder call "disconnectAudio"
        ///     setBluetoothSco(false) must be executed synchronously.
        ///   The action to setBluetoothSco(false) shouldn't be executed asynchrously
        ///     in HeadsetStateMachine
        ((AudioManager)getSystemService(Context.AUDIO_SERVICE)).setBluetoothScoOn(false);
        /// @}
