...
final class AdapterState extends StateMachine {
    ...
    /// M: ALPS01293574: Work arround for stopping service caused by system busy
    private static final int STOP_TIMEOUT_DELAY = 10000;
    ...
    private class OffState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch(msg.what) {
                ...
                /// M: Whole chip reset @{
                case RESET:
                    if (DBG) Log.d(TAG,"CURRENT_STATE=OFF, MESSAGE = RESET");
                    break;
                /// @}
                default:
    ...
    private class OnState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch(msg.what) {
                ...
                /// M: Whole chip reset @{
                case RESET:
                    if (DBG) Log.d(TAG,"CURRENT_STATE=ON, MESSAGE = RESET");
                    notifyWholeChipReset();
                    break;
                /// @}
                default:
    ...
    private class PendingCommandState extends State {
        ...
        public boolean processMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                /// M: Whole chip reset @{
                case RESET:
                    if (DBG) Log.d(TAG,"CURRENT_STATE=PENDING, MESSAGE = RESET, isTurningOn=" + isTurningOn + ", isTurningOff=" + isTurningOff);
                    Log.i(TAG,"CURRENT_STATE=PENDING: Deferring RESET");
                    deferMessage(msg);
                    break;
                /// @}
                default:
    ...
    /// M: Whole chip reset @{
    void adapterResetIndCallback() {
        if (DBG) Log.d(TAG, "adapterResetIndCallback");
        sendMessage(RESET);
    }

    private void notifyWholeChipReset() {
        if (DBG) Log.d(TAG, "notifyWholeChipReset");
        mAdapterService.handleWholeChipReset();
    }
    /// @}
