...
public class BluetoothTestUtils extends Assert {
    ...
    public void discoverable(BluetoothAdapter adapter) {
        ...
        writeOutput(String.format("discoverable() scanMode = %d", scanMode));
    ...
    public void undiscoverable(BluetoothAdapter adapter) {
        ...
        int scanMode = adapter.getScanMode();
        writeOutput(String.format("undiscoverable() scanMode = %d", scanMode));
    ...
    public void startScan(BluetoothAdapter adapter) {
        ...
        writeOutput(String.format("startScan() isDiscovering = %b", adapter.isDiscovering()));
    ...
    public void stopScan(BluetoothAdapter adapter) {
        ...
        writeOutput(String.format("stopScan() isDiscovering = %b", adapter.isDiscovering()));
    ...
    private void pairOrAcceptPair(BluetoothAdapter adapter, BluetoothDevice device, int passkey,
        ...
        int mask = PairReceiver.STATE_BONDING_FLAG | PairReceiver.STATE_NONE_FLAG;
        long start = -1;
        String methodName;
        if (shouldPair) {
