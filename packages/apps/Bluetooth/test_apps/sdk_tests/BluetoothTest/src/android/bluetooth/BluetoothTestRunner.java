...
public class BluetoothTestRunner extends JUnitReportTestRunner {
    ...
    public static boolean sIsWithBtDongle = false;
    public static int sEnableIterations = 1; //100;
    public static int sDiscoverableIterations = 1; //1000;
    public static int sScanIterations = 1; //1000;
    public static int sEnablePanIterations = 1; //1000;
    public static int sPairIterations = 1; //100;
    public static int sConnectHeadsetIterations = 1; //100;
    public static int sConnectA2dpIterations = 1; //100;
    public static int sConnectInputIterations = 1; //100;
    public static int sConnectPanIterations = 1; //100;
    public static int sStartStopScoIterations = 1; //100;

    public static String sDeviceAddress = "00:15:83:4C:F1:9B"; // dongle
    // public static String sDeviceAddress = "9C:B7:0D:11:76:F1"; // Jabra Clipper
    public static byte[] sDevicePairPin = {'0', '0', '0', '0'};
    ...
    public TestSuite getAllTests() {
        ...
        if(sIsWithBtDongle)
        {
            suite.addTestSuite(BluetoothStressTestWithBtDongle.class);
        }
        return suite;
    }
    ...
    public void onCreate(Bundle arguments) {
        ...
        String val = arguments.getString("with_bt_dongle");
        if (val != null) {
            try {
                sIsWithBtDongle = Boolean.parseBoolean(val);
            } catch (NumberFormatException e) {
                // Invalid argument, fall back to default value
            }
        }
        
        val = arguments.getString("enable_iterations");
        if (val != null) {
            try {
