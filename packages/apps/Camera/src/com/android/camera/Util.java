...
public class Util {
    ...
    // add for debug thumbnail, can save bitmap map as jpg file keep original size
    ...
    private static boolean isMountPointValid(Uri uri, ContentResolver resolver) {
        ...
        Log.d(TAG, "isMountPointValid(" + uri + ") path =" + path
    ...
    public static String createJpegName(long dateTaken) {
        synchronized (sImageFileNamer) {
            return sImageFileNamer.generateName(dateTaken,0);
        }
    }
    ...
    public static class ImageFileNamer {
        ...
        public String generateName(long dateTaken,int tag) {
            Date date = new Date(dateTaken);
            String result = mFormat.format(date);

            // If the last name was generated for the same second,
            // we append _1, _2, etc to the name.
            if (dateTaken / 1000 == mLastDate / 1000 && tag == 0) {
                mSameSecondCount++;
