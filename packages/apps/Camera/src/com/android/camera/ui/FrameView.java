...
/**
 * The boxView base class, because the face view and object view are incompatible, 
 * so we can define common.
 * 
 */
public class FrameView extends View implements FocusIndicator{
    ...
    public FrameView(Context context, AttributeSet attr) {
        ...
        mTrackStatusIndicator = mContext.getFrameManager().getViewDrawable(FrameManager.OBJECT_TYPE);
    }
    ...
    public void setFocusIndicatorRotateLayout(
            FocusIndicatorRotateLayout indicator) {
