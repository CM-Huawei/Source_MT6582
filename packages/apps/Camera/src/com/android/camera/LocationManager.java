...
public class LocationManager {
    ...
    LocationListener mLocationListener = new LocationListener(android.location.LocationManager.FUSED_PROVIDER);
    ...
    public Location getCurrentLocation() {
        ...
        if (mRecordLocation) {
            ...
            location = mLocationListener.current();
        }
        Log.d(TAG, "getCurrentLocation() mRecordLocation=" + mRecordLocation + ", return " + location);
        return location;
    }
    ...
    private void startReceivingLocationUpdates() {
        ...
        if (mLocationManager != null) {
            try {
                android.location.LocationRequest request  = android.location.LocationRequest.create();
                request.setQuality(android.location.LocationRequest.POWER_HIGH);
                request.setProvider(android.location.LocationManager.FUSED_PROVIDER);
    ...
    private class LocationListener
        ...
        public void onLocationChanged(Location newLocation) {
            Log.i(TAG, "onLocationChanged(" + newLocation + ") mRecordLocation=" + mRecordLocation
        ...
        public void onStatusChanged(String provider, int status, Bundle extras) {
            Log.i(TAG, "onStatusChanged(" + provider + ", " + status + ") mRecordLocation="
