                    ...
                    if (handoverStatus == HANDOVER_TRANSFER_STATUS_SUCCESS) {
                        ...
                        if (!incoming) {                            
                            try {
                                ...
                                FilePushRecord.sendBtOutgoingIntent(context,uriString, mimeType, true, f.length(), f.length());
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                        ...
                        if (incoming) {
                            ...
                            FilePushRecord.sendBtIncomingIntent(context,uriString, mimeType, false, doneSize, fileSize);
                        } else {
                            FilePushRecord.sendBtOutgoingIntent(context,uriString, mimeType, false, doneSize, fileSize);
                        }
						/// }                    
