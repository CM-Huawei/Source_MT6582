...
public class HandoverManager {
    ...
    public HandoverManager(Context context) {
        ...
        /// M: @{
        filter.addAction("android.intent.action.AFTER_BOOT_IPO.NFC_BindHandoverService");
        /// }
    ...
    final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            /// M: @{
            if (action.equals("android.intent.action.AFTER_BOOT_IPO.NFC_BindHandoverService")) {

                Log.d(TAG, "=======================");
                Log.d(TAG, "AFTER_BOOT_IPO.NFC_BindHandoverService    bindService");
                Log.d(TAG, "=======================");
    ...
    /// M: @ {
    public NdefMessage createHandoverRequestMessageEx(Uri[] uris) {
        return MtkHandoverManager.getInstance().CreateHrMEntry(uris);
    }

    public NdefMessage tryHandoverRequestEx(NdefMessage m) {
        return MtkHandoverManager.getInstance().tryMtkHandoverRequest(m);
    }

    public void doHandoverUriEx(Uri[] uris, NdefMessage m) {
        MtkHandoverManager.getInstance().doHsMHandoverEntry(uris, m);
    }
    /// }
}
