...
public class DialerDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void updateSmartDialDatabase() {
        ...
        synchronized(mLock) {
             ...
             * update time.
             */
            // / M: fix alps01256231, for cursor leak. @{
            //original code: final Cursor updatedContactCursor = mContext.getContentResolver().query(PhoneQuery.URI,
            // / @}
            Cursor updatedContactCursor = mContext.getContentResolver().query(PhoneQuery.URI,
             ...
             */
            // / M: fix alps01256231, for cursor leak. @{
            //original code: final Cursor nameCursor = db.rawQuery(
            // / @}
