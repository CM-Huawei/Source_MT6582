...
public class CallTypeIconsView extends View {
    ...
    public void add(int callType, int isVtCall) {
    ...
    private Drawable getCallTypeDrawable(int callType, int isVtCall) {
        ...
        default:
            // It is possible for users to end up with calls with unknown call
            // types in their
            // call history, possibly due to 3rd party call log implementations
            // (e.g. to
            // distinguish between rejected and missed calls). Instead of
            // crashing, just
            // assume that all unknown call types are missed calls.
            return mResources.missed;
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (Integer callType : mCallTypes) {
            final Drawable drawable = getCallTypeDrawable(callType, mVTCall);
