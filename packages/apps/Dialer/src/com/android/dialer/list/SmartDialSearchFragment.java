...
public class SmartDialSearchFragment extends SearchFragment {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        adapter.setShortcutEnabled(SmartDialNumberListAdapter.SHORTCUT_ADD_NUMBER_TO_CONTACTS, true);
    }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        if (id == getDirectoryLoaderId()) {
            ...
            /**
             * original code: SmartDialCursorLoader loader = new
             * SmartDialCursorLoader(super.getContext());
             */
            Loader<Cursor> loader = null;
            if (DialerUtils.isDialerSearchEnabled()) {
                loader = new DialerSearchCursorLoader(super.getContext(), usesCallableUri());
            } else {
                loader = new SmartDialCursorLoader(super.getContext());
            }
            /// M: @}
