...
public class PhoneFavoriteMergedAdapter extends BaseAdapter {
    ...
    private final CallLogQueryHandlerEx mCallLogQueryHandler;
    ...
    private final CallLogQueryHandlerEx.Listener mCallLogQueryHandlerListener =
            new CallLogQueryHandlerEx.Listener() {
        @Override
        ...
        /// M: add for phone favorite fragment refactoring.@{
    ...
    public PhoneFavoriteMergedAdapter(Context context,
        ...
        */
        mCallLogQueryHandler = new CallLogQueryHandlerEx(mContext.getContentResolver(),
