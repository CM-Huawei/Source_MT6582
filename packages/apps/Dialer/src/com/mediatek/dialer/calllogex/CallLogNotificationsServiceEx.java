 ...
 * </ul>
 */
public class CallLogNotificationsServiceEx extends IntentService {
    ...
    public CallLogNotificationsServiceEx() {
    ...
    public void onCreate() {
        super.onCreate();
        mCallLogQueryHandler = new CallLogQueryHandlerEx(getContentResolver(), null /*listener*/);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        if (ACTION_MARK_NEW_VOICEMAILS_AS_OLD.equals(intent.getAction())) {
            ...
            DefaultVoicemailNotifierEx.getInstance(this).updateNotification(voicemailUri);
        } else {
