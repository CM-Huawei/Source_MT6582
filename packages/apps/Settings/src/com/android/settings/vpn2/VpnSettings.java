...
public class VpnSettings extends SettingsPreferenceFragment implements
    ...
    public void onClick(DialogInterface dialog, int button) {
        if (button == DialogInterface.BUTTON_POSITIVE) {
            ...
            if (preference != null) {
                ...
                ///M:update VPN to invalid, delete this vpn in lockdown list @{
                if (mDialog.isEditing()) {
                    Log.d(TAG, "update VPN and then update lockdown list");
                    String selectedKey = profile.key;
                    if (!profile.isValidLockdownProfile()) {
                        if (deleteLockdownItem(selectedKey)) {
     ...
     */
    private boolean deleteLockdownItem(String selectedKey) {
        boolean res = false;
        final KeyStore keyStore = KeyStore.getInstance();
        final String lockdownKey = LockdownConfigFragment.getStringOrNull(keyStore, Credentials.LOCKDOWN_VPN);
        Log.v(TAG, "lockdownKey = " + lockdownKey + ",selectedKey" + selectedKey);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.string.vpn_menu_delete:
                ...
                deleteLockdownItem(mSelectedKey);
                return true;
        }
        return false;
    }
