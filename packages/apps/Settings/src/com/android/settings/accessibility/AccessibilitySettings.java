...
public class AccessibilitySettings extends SettingsPreferenceFragment implements DialogCreatable,
    ...
    private static final float LARGE_FONT_SCALE_TABLET = 1.30f;
    ...
    public void onResume() {
        ...
        /** M: MTK sync Auto-Rotation with status bar, CR ALPS00256660*/  
    ...
    public void onPause() {
        ...
        /** M: sync Auto-Rotation with status bar, CR ALPS00256660 */  
    ...
    private void initializeAllPreferences() {
        ...
        /// M: IPO settings
        mIpoSetting = (CheckBoxPreference) findPreference(IPO_SETTING_PREFERENCE);
                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent marketIntent = new Intent(Intent.ACTION_VIEW,
                                                marketUri);
                                        /// M: MTK fix JE in Accessibility, CR ALPS00111739 @{
                                        try {
                                            if (marketIntent != null) {
                                                startActivity(marketIntent);
                                            }
                                        } catch (ActivityNotFoundException e) {
                                            Log.i(LOG_TAG, "cannot launch the talkback app because GMS isn't installed.");
                                        }
                                        /// @} end
                                    }
                                })
    ...
    /** M: CR ALPS00279936, this is invoke for rotation configuration changed.
     */
    @Override
    public void onConfigurationChanged(Configuration newConfig) {
       super.onConfigurationChanged(newConfig);
       mCurConfig.updateFrom(newConfig);
       /// M: CR ALPS00334527, text was cut issue when large font
