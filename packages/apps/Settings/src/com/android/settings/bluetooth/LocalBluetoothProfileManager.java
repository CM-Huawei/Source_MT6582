...
final class LocalBluetoothProfileManager {
    ...
    private class PanStateChangedHandler extends StateChangedHandler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice device) {
            ...
            Xlog.d(TAG, "pan profile state change, role is " + role);
    ...
    synchronized void updateProfiles(ParcelUuid[] uuids, ParcelUuid[] localUuids,
        ...
        profiles.clear();
        Xlog.d(TAG, "update profiles");
        if (uuids == null) {
            Xlog.d(TAG, "remote device uuid is null");
            return;
        }
        ...
        if (mHeadsetProfile != null) {
            if ((BluetoothUuid.isUuidPresent(localUuids, BluetoothUuid.HSP_AG) &&
                ...
                Xlog.d(TAG, "Add HeadsetProfile to connectable profile list");
        ...
        if (BluetoothUuid.containsAnyUuid(uuids, A2dpProfile.SINK_UUIDS) &&
            mA2dpProfile != null) {
            Xlog.d(TAG, "Add A2dpProfile to connectable profile list");
        ...
        if (BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.ObexObjectPush) &&
            mOppProfile != null) {
            Xlog.d(TAG, "Add OppProfile to connectable profile list");
        ...
        if ((BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.Hid) ||
            ...
            mHidProfile != null) {
            Xlog.d(TAG, "Add HidProfile to connectable profile list");
        ...
        if ((BluetoothUuid.isUuidPresent(uuids, BluetoothUuid.NAP) &&
            ...
            Xlog.d(TAG, "Add PanProfile to connectable profile list");
        ...
        if ((mMapProfile != null) &&
            ...
            Xlog.d(TAG, "Add MapProfile to connectable profile list");
        ...
        if (BluetoothUuid.containsAnyUuid(uuids, FtpProfile.UUIDS)
                && mFtpProfile != null) {
            Xlog.d(TAG, "Add FtpProfile to connectable profile list");
