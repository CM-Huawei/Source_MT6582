...
public final class BluetoothDevicePreference extends Preference implements
    ...
    protected void onPrepareForRemoval() {
        ...
        Xlog.d(TAG, "onPrepareForRemoval");
        mCachedDevice.unregisterCallback(this);
        if (mDisconnectDialog != null) {
            Xlog.d(TAG, "dismiss dialog");
    ...
    private int getConnectionSummary() {
        ...
        Xlog.d(TAG, mCachedDevice.getName() + " getConnectionSummary");
        ...
        for (LocalBluetoothProfile profile : cachedDevice.getProfiles()) {
            ...
            if (profile != null) {
                Xlog.d(TAG, "profile name is " + profile.toString() + ": " + connectionStatus);
            }
            ...
            case BluetoothProfile.STATE_CONNECTED:
                Xlog.d(TAG, "profileConnected = true");
            ...
            case BluetoothProfile.STATE_DISCONNECTED:
                if (profile.isProfileReady() && profile.isPreferred(cachedDevice.getDevice())) {
                    if (profile instanceof A2dpProfile) {
                        Xlog.d(TAG, "a2dpNotConnected = true");
                        a2dpNotConnected = true;
                    } else if (profile instanceof HeadsetProfile) {
                        Xlog.d(TAG, "headsetNotConnected = true");
    ...
    private int getBtClassDrawable() {
        ...
        if (btClass != null) {
            ...
            switch (btClass.getMajorDeviceClass()) {
                ...
                Xlog.d(TAG, "unrecognized device class " + btClass);
            }
        } else {
