...
public final class CredentialStorage extends Activity {
    ...
    protected void onDestroy() {
        Xlog.d(TAG, "onDestroy, set sConfigureKeyGuardDialog as null");
    ...
    private void installIfAvailable() {
        if (mInstallBundle != null && !mInstallBundle.isEmpty()) {
            ...
            if (bundle.containsKey(Credentials.EXTRA_WAPI_USER_CERTIFICATE_NAME)) {
                ...
                if (caListName != null && !mKeyStore.put(caListName, caListData, uid, KeyStore.FLAG_ENCRYPTED)) {
                    Log.e(TAG, "Failed to install " + caListName + " as user " + uid);
                    return;
                }
            }
            ...
            implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener
    {
        ...
        private ConfigureKeyGuardDialog() {
            ...
            if (sConfigureKeyGuardDialog == null) {
                AlertDialog dialog = new AlertDialog.Builder(CredentialStorage.this)
                    ...
                    .setNegativeButton(android.R.string.cancel, this)
                    .create();
                Xlog.d(TAG, "create sConfigureKeyGuardDialog");
        ...
        @Override
        public void onDismiss(DialogInterface dialog) {
            Xlog.d(TAG, "on dimiss, set sConfigureKeyGuardDialog as null");
            sConfigureKeyGuardDialog = null;
