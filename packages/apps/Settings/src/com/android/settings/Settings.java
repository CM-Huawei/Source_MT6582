...
import com.mediatek.gemini.SimRoamingSettings;
...
public class Settings extends PreferenceActivity
    ...
    private void updateSimState() {
        ...
        Trace.traceCounter(Trace.TRACE_TAG_GRAPHICS,"AppUpdate",1);
        ListAdapter listAdapter = getListAdapter();
        if (listAdapter instanceof HeaderAdapter) {
            ((HeaderAdapter) listAdapter).isSimManagementAvailable(this);
        }
        invalidateHeaders(); 
        Trace.traceCounter(Trace.TRACE_TAG_GRAPHICS,"AppUpdate",0);
    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            /**@ }*/
                ...
                ///M :add International roaming feature
                mExt.addCustomizedItem(target, i+1);
                ...
                if (!getPackageManager().hasSystemFeature(PackageManager.FEATURE_NFC)) {
                    ...
                    //M: Feature not ready comment temp
                    target.remove(i);
                    //
                }
    ...
    private static class HeaderAdapter extends ArrayAdapter<Header> {
        ...
        private void updateCommonHeaderView(Header header, HeaderViewHolder holder) {
                ...
                } else if (mExt.needCustomizeHeaderIcon(header)) {
                    /// M: customize header icon from operator package.
                    mExt.customizeHeaderIcon(holder.icon, header);
                } else {
        ...
        public void isSimManagementAvailable(Context context) {
            ...
            boolean isHasSimCards = (com.mediatek.telephony.SimInfoManager.getInsertedSimCount(context) != 0); 
    ...
    public static class HotKnotSettingsActivity extends Settings {/*empty */}   
    /**@}*/    
