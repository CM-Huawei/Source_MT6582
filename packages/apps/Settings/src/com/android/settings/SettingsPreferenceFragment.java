...
public class SettingsPreferenceFragment extends PreferenceFragment implements DialogCreatable {
    ...
    protected void removeDialog(int dialogId) {
        ...
        if (mDialogFragment != null && mDialogFragment.getDialogId() == dialogId) {
            mDialogFragment.dismiss();
           /** M: do not set dialogfragment to null if dialog id is not the same
               CR ALPS00577625.*/
            mDialogFragment = null;
        }
    }
    ...
    ///M: when tablet getConfiguration changed,setPadding @{
    @Override
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if ("tablet".equals(SystemProperties.get("ro.build.characteristics"))) {
            ...
            int left = (int)getResources().getDimension(R.dimen.settings_side_margin);
            int right = left;
