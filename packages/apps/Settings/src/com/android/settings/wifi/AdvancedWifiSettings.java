...
public class AdvancedWifiSettings extends SettingsPreferenceFragment
    ...
    /// M: add Passpoint
    private PasspointSettings mPasspointSettings;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(action)) {
                ...
                if (state == WifiManager.WIFI_STATE_ENABLED) {
                    ...
                    /// M: add Passpoint
                    if (FeatureOption.MTK_PASSPOINT_R1_SUPPORT && mPasspointSettings != null) {
                        mPasspointSettings.refreshPasspointPreference(true);
                    }
                } else if (state == WifiManager.WIFI_STATE_DISABLED) {
                    mNotifyOpenNetworks.setEnabled(false);
                    /// M: add Passpoint
                    if (FeatureOption.MTK_PASSPOINT_R1_SUPPORT && mPasspointSettings != null) {
                        mPasspointSettings.refreshPasspointPreference(false);
                    }
                }
            }
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (FeatureOption.MTK_PASSPOINT_R1_SUPPORT) {
            mPasspointSettings = new PasspointSettings(getActivity());
        }
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        /// M: add Passpoint
        if (FeatureOption.MTK_PASSPOINT_R1_SUPPORT && mPasspointSettings != null) {
            mPasspointSettings.addPasspointPreference(getPreferenceScreen());
        }
        /// M: init view @{
    ...
    public void onResume() {
        ...
        /// M: add Passpoint
        if (FeatureOption.MTK_PASSPOINT_R1_SUPPORT && mPasspointSettings != null) {
            mPasspointSettings.refreshPasspointPreference(mWifiManager.isWifiEnabled());
         }
    }
    @Override
    public void onPause() {
    ...
    private void initPreferences() {
        ...
        if (poorNetworkDetection != null) {
            boolean poorLinkEnable = SystemProperties.getBoolean("persist.sys.poorlinkEnable",false);
            Log.d(TAG, "poorLinkEnable = " + poorLinkEnable);
            if (poorLinkEnable) {
        ...
        if (sleepPolicyPref != null) {
            ...
            mExt.setSleepPolicyPreference(sleepPolicyPref, getResources().getStringArray((Utils.isWifiOnly(getActivity()) 
                    ? R.array.wifi_sleep_policy_entries_wifi_only : R.array.wifi_sleep_policy_entries)), 
                    getResources().getStringArray(R.array.wifi_sleep_policy_values));
    ...
    private void refreshWifiInfo() {
        ...
        if (FeatureOption.MTK_DHCPV6C_WIFI && ipAddress != null) {
            ...
            String ipV4Address = Utils.getWifiIpAddresses(getActivity());
            mIpAddressPref.setSummary(ipV4Address == null ?
                    getActivity().getString(R.string.status_unavailable) : ipV4Address);
