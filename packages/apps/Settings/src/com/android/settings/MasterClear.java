...
public class MasterClear extends Fragment {
    ...
    /// M: CT spec: Factory reset plugin @{
    static final String ERASE_INTERNAL_EXTRA = "erase_internal_data";
    private IFactoryExt mExt;
    /// @}
    ...
    private void showFinalConfirmation() {
        ...
        Xlog.d(TAG, "(data | app), status = " + status);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /// M: plugin @{
        mExt = Utils.getFactoryPlugin(getActivity());
        mExt.updateContentViewLayout((ViewGroup)mContentView, R.id.accounts_label);
        List<View> lists = new ArrayList<View>();
        lists.add(mContentView.findViewById(R.id.not_encrypted_erase));
        lists.add(mContentView.findViewById(R.id.master_clear_desc));
        lists.add(mContentView.findViewById(R.id.also_erases_external));
        lists.add(mContentView.findViewById(R.id.erase_external_option_text));
        lists.add(mContentView.findViewById(R.id.erase_external_container));
        mExt.setLayout(lists);
        /// @}
        return mContentView;
    }
