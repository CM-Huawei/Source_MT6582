...
public class SecuritySettings extends RestrictedSettingsFragment
    ...
    // add plugin for permission control
    private IPermissionControlExt mPermCtrlExt;
    // add plugin for privacy protection lock
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // M: get getPermControlExtPlugin
        mPermCtrlExt = (IPermissionControlExt)Utils.getPermControlExtPlugin(getActivity());
        // M: get getPrivacyProtectionLockExtPlugin
        mPplExt = (IPplSettingsEntryExt)Utils.getPrivacyProtectionLockExtPlugin(getActivity());
        mMdmPermCtrlExt = (IMdmPermissionControlExt)Utils.getMdmPermControlExtPlugin(getActivity());
    }
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if (!(Utils.isWifiOnly(getActivity()))) {
            ...
            if (root.findPreference(KEY_SIM_LOCK) != null) {
                ...
                List<SimInfoRecord> simList = SimInfoManager
                        .getInsertedSimInfoList(getActivity());
        ...
        /* M: add by mtk,  @ { */
        Preference credentialsPreference = root.findPreference(KEY_CREDENTIALS_INSTALL);
        String volumeDescription = Utils.getVolumeDescription(getActivity());
        String title = Utils.getVolumeString(R.string.credentials_install, volumeDescription, getActivity());
        String summary = Utils.getVolumeString(R.string.credentials_install_summary, volumeDescription, getActivity());
        credentialsPreference.setTitle(title);
        credentialsPreference.setSummary(summary);
        /* @ } */
