...
public class BeamShareTabAdapter extends ResourceCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (task.getDirection() == Direction.in) {
            icon.setImageResource((task.getState() == BeamShareTask.STATE_SUCCESS) ? 
                              R.drawable.ic_beamplus_list_receiver
                            : R.drawable.ic_beamplus_list_failed);
        } else {
            icon.setImageResource((task.getState() == BeamShareTask.STATE_SUCCESS) ? 
                              R.drawable.ic_beamplus_list_sender
                            : R.drawable.ic_beamplus_list_failed);
        }
