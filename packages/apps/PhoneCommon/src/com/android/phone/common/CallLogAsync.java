...
public class CallLogAsync {
    ...
    public static class AddCallArgs {
        ...
        public AddCallArgs(Context context,
                ...
                long durationInMillis,
                int simId) {
            this(context, ci, number, presentation, callType, timestamp, durationInMillis, simId, -1);
        }
        ...
        /// M: @{
        /** Indicate the Call SIM id */
        public final int mSimId;
        /** Indicate the call is VT or not.*/
        public final int mVtCall;
        /// @}
    }
    ...
    /**
     * M: add for missed call notification
     */
    public AsyncTask addCall(AddCallArgs args, OnInsertCompleteListener listener) {
        assertUiThread();
        return new AddCallTask(listener).execute(args);
    }
    ...
    public interface OnInsertCompleteListener {
        /**
         * Call log insert is complete.
         *
         * @param conn the connection of current call.
         */
    ...
    private class AddCallTask extends AsyncTask<AddCallArgs, Void, Uri[]> {
        ///M: add for missed call photo on notification.
        private OnInsertCompleteListener mListener = null;

        public AddCallTask(){
        }

        public AddCallTask(OnInsertCompleteListener listener){
            mListener = listener;
        }
            ...
            for (int i = 0; i < count; i++) {
                ...
                try {
                    ...
                    result[i] = Calls.addCall(
                            ...
                            c.callType, c.timestamp, c.durationInSec, c.mSimId, c.mVtCall);
                } catch (Exception e) {
                ...
                /// M: add log for CallLog
                Log.d(TAG, "Calls.addCall, number=" + c.number + " presentation:" + c.presentation
                        + " callType:" + c.callType + " timestamp:" + c.timestamp
                        + " durationInSec:" + c.durationInSec + " simId: " + c.mSimId
                        + " vtCall:" + c.mVtCall);
            }
            return result;
        }
