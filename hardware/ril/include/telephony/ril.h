...
#define RIL_REQUEST_SET_REG_SUSPEND_ENABLED (RIL_REQUEST_MTK_BASE + 76)
#define RIL_REQUEST_RESUME_REGISTRATION (RIL_REQUEST_MTK_BASE + 77)
#define RIL_REQUEST_STORE_MODEM_TYPE (RIL_REQUEST_MTK_BASE + 78)
#define RIL_REQUEST_QUERY_MODEM_TYPE (RIL_REQUEST_MTK_BASE + 79)
#define RIL_REQUEST_SIM_INTERFACE_SWITCH (RIL_REQUEST_MTK_BASE + 80)

// WiFi Calling start
#define RIL_REQUEST_UICC_SELECT_APPLICATION (RIL_REQUEST_MTK_BASE + 81)

#define RIL_REQUEST_UICC_DEACTIVATE_APPLICATION (RIL_REQUEST_MTK_BASE + 82)

#define RIL_REQUEST_UICC_APPLICATION_IO (RIL_REQUEST_MTK_BASE + 83)

#define RIL_REQUEST_UICC_AKA_AUTHENTICATE (RIL_REQUEST_MTK_BASE + 84)

#define RIL_REQUEST_UICC_GBA_AUTHENTICATE_BOOTSTRAP (RIL_REQUEST_MTK_BASE + 85)

#define RIL_REQUEST_UICC_GBA_AUTHENTICATE_NAF (RIL_REQUEST_MTK_BASE + 86)
// WiFi Calling end
#define RIL_REQUEST_STK_EVDL_CALL_BY_AP (RIL_REQUEST_MTK_BASE + 87)

// Femtocell (CSG)
#define RIL_REQUEST_GET_FEMTOCELL_LIST (RIL_REQUEST_MTK_BASE + 88)
#define RIL_REQUEST_ABORT_FEMTOCELL_LIST (RIL_REQUEST_MTK_BASE + 89)
#define RIL_REQUEST_SELECT_FEMTOCELL (RIL_REQUEST_MTK_BASE + 90)
//Network OPLMN
#define RIL_REQUEST_SEND_OPLMN (RIL_REQUEST_MTK_BASE + 91)
#define RIL_REQUEST_GET_OPLMN_VERSION (RIL_REQUEST_MTK_BASE + 92)

//PLMN List abort
#define RIL_REQUEST_ABORT_QUERY_AVAILABLE_NETWORKS (RIL_REQUEST_MTK_BASE + 93)
// Dial up for CSD
#define RIL_REQUEST_DIAL_UP_CSD (RIL_REQUEST_MTK_BASE + 94)

#define RIL_REQUEST_SET_TELEPHONY_MODE (RIL_REQUEST_MTK_BASE + 95)
...
#define RIL_LOCAL_REQUEST_QUERY_MODEM_THERMAL (RIL_LOCAL_REQUEST_MTK_BASE + 2)
#define RIL_LOCAL_REQUEST_RILD_READ_IMSI (RIL_LOCAL_REQUEST_MTK_BASE + 3)
...
#define RIL_UNSOL_RESPONSE_PLMN_CHANGED (RIL_UNSOL_MTK_BASE + 30)
#define RIL_UNSOL_RESPONSE_REGISTRATION_SUSPENDED (RIL_UNSOL_MTK_BASE + 31)

#define RIL_UNSOL_STK_EVDL_CALL (RIL_UNSOL_MTK_BASE + 32)

//MTK-START [mtk80881] for Modem indication of RB release
#define RIL_UNSOL_DATA_PACKETS_FLUSH (RIL_UNSOL_MTK_BASE + 33)
//MTK-END [mtk80881] for Modem indication of RB release

#define RIL_UNSOL_CIPHER_INDICATION (RIL_UNSOL_MTK_BASE + 34)

#define RIL_UNSOL_FEMTOCELL_INFO (RIL_UNSOL_MTK_BASE + 35)
#define RIL_UNSOL_CNAP (RIL_UNSOL_MTK_BASE + 36)
// RAC update indication //sm cause rac
#define RIL_UNSOL_RAC_UPDATE (RIL_UNSOL_MTK_BASE + 37)
