 ...
 */
enum {
    /* HWC_PROTECTED_LAYER is set by SurfaceFlinger to indicat that the HAL
     * this layer is protected
     */
    HWC_PROTECTED_LAYER = 0x10000000,
...
enum {
    ...
    HWC_SCREEN_FROZEN         = 0x40000000,
    HWC_MIRROR_DISPLAY        = 0x80000000,

    // HWC_MIRRORED_DISP_MASK is useing second byte for checking mirror display
