...
public abstract class PhoneBase extends Handler implements Phone {
    ...
    //MTK-START [mtk04070][111117][ALPS00093395]MTK added
    protected static final int EVENT_SIP_CALL_RING                  = 31;
    // Events for Call Forwarding Info flag
    protected static final int EVENT_CFU_IND                        = 32;
    // Events for Call Related SuppSvc Notificaiton
    protected static final int EVENT_CRSS_IND                       = 33;
    //Add by mtk80372 for Barcode Number
    protected static final int EVENT_GET_BARCODE_NUMBER             = 34;
    //3G switch
    protected static final int EVENT_GET_3G_CAPABILITY              = 35;
    protected static final int EVENT_SET_3G_CAPABILITY              = 36;
    //MTK-END [mtk04070][111117][ALPS00093395]MTK added

    // ALPS00294581 Replace "RIL_UNSOL_SIM_MISSING in RIL.java" with "acively query SIM missing status"
    protected static final int EVENT_QUERY_SIM_MISSING_STATUS       = 37;

    //MTK-START [mtk80950][120410][ALPS00266631]check whether download calibration data or not
    protected static final int EVENT_GET_CALIBRATION_DATA_DONE      = 38;
    //MTK-END [mtk80950][120410][ALPS00266631]check whether download calibration data or not

    protected static final int EVENT_VOICE_CALL_INCOMING_INDICATION = 39;

    protected static final int EVENT_CIPHER_INDICATION = 40;
    ...
    protected static final int EVENT_CFU_QUERY_TIMEOUT = 201;
    ...
    /** List of Registrants to receive radio state Notifications. */
    ...
    protected PhoneBase(String name, PhoneNotifier notifier, Context context, CommandsInterface ci,
        ...
        mActionDetached = this.getClass().getPackage().getName() + ".action_detached";
        mActionAttached = this.getClass().getPackage().getName() + ".action_attached";
        Rlog.d(LOG_TAG, "[PhoneBase] mysimId:" + mySimId);
    ...
    public void dispose() {
        synchronized(PhoneProxy.lockForRadioTechnologyChange) {
            Rlog.d(LOG_TAG, "[PhoneBase] dispose");
    ...
    public void handleMessage(Message msg) {
        ...
        switch(msg.what) {
            ...
            case EVENT_ICC_CHANGED:
                Rlog.d(LOG_TAG, "Event EVENT_ICC_CHANGED Received stat=" + getState());
    ...
    */
    ...
    private List<CellInfo> privatizeCellInfoList(List<CellInfo> cellInfoList) {
        ...
        if ((mode == Settings.Secure.LOCATION_MODE_OFF) && (cellInfoList!=null)) {
    ...
    public void getSmscAddress(Message result) {
        Rlog.d(LOG_TAG, "getSmscAddress");
        mCi.getSmscAddress(result);
    }

    @Override
    public void setSmscAddress(String address, Message result) {
        Rlog.d(LOG_TAG, "setSmscAddress address=" + address);    
    ...
    public void setGprsTransferType(int type, Message response) {
        mCi.setGprsTransferType(type, response);
    }
    ...
    public void getMobileRevisionAndImei(int type,Message result) {
        mCi.getMobileRevisionAndImei(type,result);
    }
    ...
    public String getApnForType(String type) {
        //Temporary mark
        return "";
    	//return mDcTracker.getApnForType(type);
        //Temporary mark
    }
    ...
    public void registerForSpeechInfo(Handler h, int what, Object obj) {
        mCi.registerForSpeechInfo(h, what, obj);
    }

    public void unregisterForSpeechInfo(Handler h) {
        mCi.unregisterForSpeechInfo(h);
    }
    ...
    public void registerForRadioOffOrNotAvailableNotification(
            Handler h, int what, Object obj) {
    ...
    public void registerForVtRingInfo(Handler h, int what, Object obj) {
        mCi.registerForVtRingInfo(h, what, obj);
    }

    public void unregisterForVtRingInfo(Handler h) {
        mCi.unregisterForVtRingInfo(h);
    }
...
//MTK-END [mtk80601][111212][ALPS00093395]IPO feature
    ...
    public String[] getDnsServers(String apnType) {
        //Temporary mark
        return null;
        //return mDcTracker.getDnsServers(apnType);
        //Temporary mark
    }
    ...
    //[CSD]
    public int dialUpCsd(int simdId, String dialUpNumber) {
        return mDcTracker.dialUpCsd(simdId, dialUpNumber);
    }
    ...
    /**
     * M: Verify mcc/mnc reported by VIA CDMA modem, add dummy interface to
     * separate from legacy CDMA implement.
     * 
     * @param mccMnc
     */
