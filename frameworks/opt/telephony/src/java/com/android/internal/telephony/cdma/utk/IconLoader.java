...
class IconLoader extends Handler {
    ...
    private RuimFileHandler mRuimFH = null;
    ...
    private IconLoader(Looper looper , RuimFileHandler fh) {
        super(looper);
        mRuimFH = fh;
    ...
    static IconLoader getInstance(Handler caller, RuimFileHandler fh) {
        if (sLoader != null) {
            return sLoader;
        }
        if (fh != null) {
