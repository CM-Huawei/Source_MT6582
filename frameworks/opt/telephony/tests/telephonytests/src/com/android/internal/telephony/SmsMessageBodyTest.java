...
public class SmsMessageBodyTest extends AndroidTestCase {
    ...
    public void testDeliverPduWithLang() throws Exception {
        ...
        Rlog.d(TAG, "testDeliverPduWithLang, pduData="+pduData.toString());
        assertTrue(true);
    }
    ...
    private void callSubmitPduMethods () throws Exception
    {
        ...
        Rlog.d(TAG, "callSubmitPduMethods, gsmPduData="+gsmPduData.toString());
        assertTrue(true);
        ...
        Rlog.d(TAG, "callSubmitPduMethods, pduData="+pduData.toString());
        assertTrue(true);
