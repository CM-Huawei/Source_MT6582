...
public class VCardUtils {
    ...
    static {
        ...
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_CALLBACK, Phone.TYPE_CALLBACK);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_COMPANY_MAIN, Phone.TYPE_COMPANY_MAIN);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_RADIO, Phone.TYPE_RADIO);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_TTY_TDD, Phone.TYPE_TTY_TDD);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_TYPE_ASSISTANT, Phone.TYPE_ASSISTANT);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_PHONE_EXTRA_OTHER_FAX,	Phone.TYPE_OTHER_FAX);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_TLX,	Phone.TYPE_TELEX);
        sKnownPhoneTypeMap_StoI.put(VCardConstants.PARAM_TYPE_MSG,	Phone.TYPE_MMS);
        ...
        sKnownImPropNameMap_ItoS.put(Im.PROTOCOL_CUSTOM, VCardConstants.PROPERTY_X_CUSTOM_IM);
        ...
        sKnownCombinationTypeMap = new HashMap<String, Integer>();
        sKnownCombinationTypeMap.put(VCardConstants.PARAM_TYPE_WORK + ";" + VCardConstants.PARAM_TYPE_PAGER, 
        		                     Phone.TYPE_WORK_PAGER);
        sKnownCombinationTypeMap.put(VCardConstants.PARAM_TYPE_WORK + ";" + VCardConstants.PARAM_TYPE_CELL, 
    ...
    public static Object getPhoneTypeFromStrings(Collection<String> types,
        ...
        if (types != null) {
        	if (types.size() >= 2) {
        		Set <String> keys = sKnownCombinationTypeMap.keySet();
        		for (Iterator iter=keys.iterator(); iter.hasNext();) {
        			String key = (String) iter.next(); 
        			boolean isExist = true;
        			for (final String type1 : types) {            	    
            	    	if (key.indexOf(type1) < 0) {
            	    		isExist = false;
            	    		break;
            	    	}
            	    }
        			if (isExist) {
        				type = sKnownCombinationTypeMap.get(key);
        				return type;
        			}
        		}
        	}
