...
public class VCardEntry {
    ...
    public enum EntryLabel {
        ...
        ANNIVERSARY,
        ANDROID_CUSTOM,
        // add for import/export group infomations feature
        EXT_GROUP
    }
...
//            }
    ...
    public final void iterateAllData(EntryElementIterator iterator) {
        ...
        /** M: NEW FEATURE add group info @(*/
        addMoreIterateOneList(iterator);
        /** @) */
...
//                		builder.append(PhoneNumberUtils.WAIT);
                    hasPauseOrWait = true;
                } else if (('0' <= ch && ch <= '9') || (i == 0 && ch == '+') || ch == ' ' || ch == PhoneNumberUtils.WAIT
                        /**M: add "-/*#.", which is legal in editor */
                        || ch == PhoneNumberUtils.PAUSE || ch == '-' || ch == '/' || ch == '*' || ch == '#' || ch == '.') {
                    builder.append(ch);
                }
            }
            if (!hasPauseOrWait) {
