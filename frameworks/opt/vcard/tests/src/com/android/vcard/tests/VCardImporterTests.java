...
public class VCardImporterTests extends VCardTestsBase {
    ...
    public void testV21ComplicatedCase() {
        ...
        elem.addExpected(Phone.CONTENT_ITEM_TYPE)
                ...
                /**
                 * M: [ALPS00233020]
                 * MTK changed the "-" rule, will cause this case fail
                 * Original code:
                .put(Phone.NUMBER, "111-555-1212");
                */
                .put(Phone.NUMBER, "111 5551212");
        elem.addExpected(Phone.CONTENT_ITEM_TYPE)
                .put(Phone.TYPE, Phone.TYPE_HOME)
                /**
                 * M: [ALPS00233020]
        ...
        elem.addExpected(StructuredPostal.CONTENT_ITEM_TYPE)
                ...
                /**
                 * M: [ALPS00280244]
                 * MTK changed the implementation of address related.
                 * now, the data1 will not store StructuredPostal.FORMATTED_ADDRESS
                 * any more, so we remove it from test case
                 * Original code:
    ...
    private void testV21Japanese1Common(int resId, int vcardType, boolean japanese) {
        ...
        elem.addExpected(Phone.CONTENT_ITEM_TYPE)
                 ...
                 */
                .put(Phone.NUMBER, (japanese ? "0300000000" : "0300000000"))
                .put(Phone.TYPE, Phone.TYPE_OTHER)
                .put(Phone.IS_PRIMARY, 1);
    }
    ...
    public void testV21Japanese2_Type_Generic_Utf8() {
        ...
        elem.addExpected(StructuredName.CONTENT_ITEM_TYPE)
                ...
                /**
                 * M: [ALPS00280244]
                 * MTK changed the import/export data define.
                 * no longer put StructuredName.DISPLAY_NAME in data1, so we
                 * remove this
                 * Original code:
                ...
                .put(StructuredName.PHONETIC_GIVEN_NAME, "\uFF9B\uFF72\uFF84\uFF9E\u0031");
                 @{ */
                .put(StructuredName.PHONETIC_GIVEN_NAME, "\uFF9B\uFF72\uFF84\uFF9E\u0031")
                .put(StructuredName.DISPLAY_NAME, "\u5B89\u85E4 \u30ED\u30A4\u30C9 \u0031");
                /** @} */
        /**
         * M: M: [ALPS00280244]
         * MTK changed the import/export data define.
         *         StructuredPostal.STREET ==> StructuredPostal.NEIGHBORHOOD
         *         StructuredPostal.FORMATTED_ADDRESS ==> removed
         * no longer put formatted address in data1
         * Original code:
        elem.addExpected(StructuredPostal.CONTENT_ITEM_TYPE)
    ...
    public void testCustomPropertyV21() {
        ...
        elem.addExpected(StructuredPostal.CONTENT_ITEM_TYPE)
                 ...
                 */
                .put(StructuredPostal.NEIGHBORHOOD, "street");
        elem.addExpected(Phone.CONTENT_ITEM_TYPE)
                .put(Phone.TYPE, Phone.TYPE_CUSTOM)
    ...
    public void testPauseWaitV30() {
        ...
        elem.addExpected(Phone.CONTENT_ITEM_TYPE)
                .put(Phone.TYPE, Phone.TYPE_HOME)
                /**
                 * M: [ALPS00252712][ALPS00282624]
                 * MTK changed p, w import/export feature, the case will fail
                 * Original code:
                .put(Phone.NUMBER, ",1234,5678;9");
                 */
                .put(Phone.NUMBER, "p1234p5678w9");
    }
}
