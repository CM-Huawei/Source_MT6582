...
public class LockPatternUtils {
    ...
    public final static String VOICE_UNLOCK = "voice_unlock"; /// M: fallback for VoiceUnlock
    public final static String FACE_UNLOCK = "face_unlock"; /// M: fallback for FaceUnlock
    ...
    */
    ...
    public void saveLockPattern(List<LockPatternView.Cell> pattern, boolean isFallback) {
        saveLockPattern(pattern, isFallback, FACE_UNLOCK);
    }
     ...
     * @param pattern The new pattern to save.
     * @param isFallback Specifies if this is a fallback to biometric weak
     * @param isFallbackFor Specifies if it's a face or voice unlock
     */
        ...
        try {
            ...
            if (pattern != null) {
                ...
                if (!isFallback) {
                    ...
                    if (isFallbackFor.equals(FACE_UNLOCK)) { /// M: FaceUnlock
                    ...
                    } else if (isFallbackFor.equals(VOICE_UNLOCK)){ /// M: VoiceUnlock
    ...
    public void saveLockPassword(String password, int quality, boolean isFallback) {
        saveLockPassword(password, quality, isFallback, FACE_UNLOCK, getCurrentOrCallingUserId());
    }
    ...
    public void saveLockPassword(String password, int quality, boolean isFallback, int userHandle) {
        saveLockPassword(password, quality, isFallback, FACE_UNLOCK, userHandle);
    }
