...
public final class InputManager {
    ...
    /**
     * [SmartBook]Gets the mouse pointer primary key.
     * <p>
     * Returns the permanent mouse pointer primary key.
     * </p>
     *
     * @param context The application context.
     * @return The pointer primary key as a value.
     *
     * @hide
     */
    public boolean isPointerPrimaryKeyChanged(Context context) {
        if (FeatureOption.MTK_SMARTBOOK_SUPPORT) {
            boolean changePrimaryKey = false;
            changePrimaryKey = Settings.System.getInt(context.getContentResolver(),
                        Settings.System.CHANGE_POINTER_PRIMARY_KEY, 0) != 0;
    ...
    /**
     * [SmartBook]Sets the mouse pointer primary key.
     * <p>
     * Requires {@link android.Manifest.permissions.WRITE_SETTINGS}.
     * </p>
     *
     * @param context The application context.
     * @param changePrimaryKey The pointer primary key is changed or not
     *
     * @hide
     */
    public void setPointerPrimaryKey(Context context, boolean changePrimaryKey) {
        if (FeatureOption.MTK_SMARTBOOK_SUPPORT) {
            Settings.System.putInt(context.getContentResolver(),
                    Settings.System.CHANGE_POINTER_PRIMARY_KEY, changePrimaryKey ? 1 : 0);
        }
    }
