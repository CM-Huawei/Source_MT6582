...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * M: MATV volume. This is used internally, changing this value will not
         * change the volume. See AudioManager.
         * 
         * @hide
         */
       ...
       /**
        ...
        //MTK add start
        //[ALPS00598642]add "Auto" item for SMS SIM setting
         /**
         ...
         * <p>
         * If you need to play the default ringtone at any given time, it is
         * recommended you give {@link #DEFAULT_SIP_CALL_URI} to the media
         * player. It will resolve to the set default sip call ringtone at the
         * time of playing.
         * 
         * @see #DEFAULT_SIP_CALL_URI
         * @hide
         *
         */
        ...
        /**
         * A {@link Uri} that will point to the current default sip call
         * ringtone at any given time.
         * <p>
         * If the current default ringtone is in the DRM provider and the caller
         * does not have permission, the exception will be a
    ...
    public static final class Global extends NameValueTable {
        ...
        * The value is an integer. 0: off, 1: dim, 2: dim and show image, 3: no power saving
        * @hide
        */
        ...
        * The value is an integer. The unit is second 
        * @hide
        */
        ...
        * The value is an integer. 0: TV shows black. 1: TV shows prohibitted image
        * @hide
        */
       ...
       */
       ...
       /**
        * Setting to turn on suspend optimizations at screen off on Wi-Fi hotspot. Enabled by 
        * default and needs to be set to 0 to disable it.
        * @hide
        */
       public static final String WIFI_HOTSPOT_SUSPEND_OPTIMIZATIONS_ENABLED =
               "wifi_hotspot_suspend_optimizations_enabled";

       /**
        * Setting to select wifi ap operational band. Default value 0 :2.4G or 5G
        * 2400: 2.4G; 5000: 5G
        * @hide
        */
       public static final String WIFI_AP_OPERATIONAL_BAND =
               "wifi_ap_operational_band";
       ...
       public static final String OVERLAY_DISPLAY_DEVICES = "overlay_display_devices";
        ...
        /**
         * World phone auto network select mode 0 = disable
         *                                      1 = enable
         * @hide
         */
