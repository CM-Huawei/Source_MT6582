...
public class Linkify {
    ...
    /// M: Put the protocol names to plugin for the new added protocol of
    // operators. @{
    private static String[] WEB_PROTOCOL_NAMES = ((IWebProtocolNames) MediatekClassFactory
            .createInstance(IWebProtocolNames.class)).getWebProtocolNames();
    /// @}
    ...
    public static final boolean addLinks(Spannable text, int mask) {
        ...
        if ((mask & WEB_URLS) != 0) {
            gatherLinks(links, text, Patterns.WEB_URL, WEB_PROTOCOL_NAMES,
