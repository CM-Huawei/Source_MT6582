...
public class ListView extends AbsListView {
    ...
    final int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition,
        ...
        Xlog.d(TAG, "measureHeightOfChildren adapter=" + adapter + ", startPosition=" + startPosition +
                    ", endPosition=" + endPosition + ", maxHeight=" + maxHeight + ", this=" + this);
            ...
            if (sel != null) {
                ...
                if (shouldPlaceFocus && !maintainedFocus && !sel.hasFocus()) {
                    if (sel.requestFocus()) {
                        ...
                        Xlog.d(TAG, "mSelectorRect.setEmpty in layoutChildren with sel=" + sel + ", this=" + this);
                    } else {
