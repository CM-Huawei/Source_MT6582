...
public class LinearLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG_LAYOUT) {
            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout][onMeasure] +" + level + ", " +
        ...
        if (DEBUG_LAYOUT) {
            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout][onMeasure] -" + level + ", " +
                                 "measure result = (" + getMeasuredWidth()+ "," + getMeasuredHeight() + "), " +
                                 "min dimension = (" + getSuggestedMinimumWidth() + "," + getSuggestedMinimumHeight() + "), " + "this =" + this);
        }
    }
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG_LAYOUT) {
            ...
            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] +" + level + ", pass.1, this = " + this);
        }
        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] +" + level + ", child 1: " + i + ", " + "child = " + child + ", this = " + this);
            }
            ...
            if (heightMode == MeasureSpec.EXACTLY && lp.height == 0 && lp.weight > 0) {
                ...
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 1-1: " + i + ", " +
                                         "Skipped, mTotalLength = " + mTotalLength + ", totalWeight = " + totalWeight + ", child = " + child + ", this = " + this);
                }
            } else {
                ...
                if (lp.height == 0 && lp.weight > 0) {
                    ...
                    if (DEBUG_LAYOUT) {
                        Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 1-2: " + i + ", " +
                                             "Modified, LayoutParams.height change to WRAP_CONTENT, " + ", child = " + child + ", this = " + this);
                    }
                }
                ...
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 1-2: " + i + ", " +
                                         "Measured, measure result = (" + child.getMeasuredWidth() + "," + child.getMeasuredHeight() + "), " +
                                         "mTotalLength = " + mTotalLength + ", totalWeight = " + totalWeight + ", " + "child = " + child + ", this = " + this);
                }
            }
        ...
        if (DEBUG_LAYOUT) {
            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.1, maxWidth = " + maxWidth + ", " +
                                 "weightedMaxWidth = " + weightedMaxWidth + ", alternativeMaxWidth = " + alternativeMaxWidth + ", " +
                                 "mTotalLength = " + mTotalLength + ", this = " + this);
        }
        ...
        if (useLargestChild &&
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.1.5, Use largest child, largestChildHeight = " + largestChildHeight + ", mTotalLength = " + mTotalLength + ", this = " + this);
            }
        }
        ...
        if (DEBUG_LAYOUT) {
            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] +" + level + ", pass.2, delta = " + delta + ", heightSize = " + heightSize + ", mTotalLength = " + mTotalLength + ", " +
                                 "padding (L,R,T,B) = " + mPaddingLeft + "," + mPaddingRight + "," + mPaddingTop + "," + mPaddingBottom + ", " + "this = " + this);
        }
        ...
        if (delta != 0 && totalWeight > 0.0f) {
            ...
            for (int i = 0; i < count; ++i) {
                ...
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] +" + level + ", child 2: " + i + ", " + "child = " + child + ", this = " + this);
                }
                ...
                if (childExtra > 0) {
                    ...
                    if ((lp.height != 0) || (heightMode != MeasureSpec.EXACTLY)) {
                        ...
                        if (DEBUG_LAYOUT) {
                            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 2-1-1: " + i + ", " +
                                                 "measure result = (" + child.getMeasuredWidth() + "," + child.getMeasuredHeight() + "), " +
                                                 "share = " + share + ", childHeight = " + childHeight + ", mTotalLength = " + mTotalLength + ", " + "child = " + child + ", this = " + this);
                        }
                    } else {
                        ...
                        if (DEBUG_LAYOUT) {
                            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 2-1-2: " + i + ", " +
                                                 "measure result = (" + child.getMeasuredWidth() + "," + child.getMeasuredHeight() + "), " +
                                                 "share = " + share + ", mTotalLength = " + mTotalLength + ", " + "child = " + child + ", this = " + this);
                        }
                    }
                    ...
                    if (DEBUG_LAYOUT) {
                        Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 2-1-3: " + i + ", " +
                                             "ChildExtra = " + childExtra + ", mTotalLength = " + mTotalLength + ", " + "child = " + child + ", this = " + this);
                    }
                }
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.2-1, maxWidth = " + maxWidth + ", " +
                                    "weightedMaxWidth = " + weightedMaxWidth + ", alternativeMaxWidth = " + alternativeMaxWidth + ", " +
                                    "mTotalLength = " + mTotalLength + ", this = " + this);
            ...
            if (useLargestChild && heightMode != MeasureSpec.EXACTLY) {
                for (int i = 0; i < count; i++) {
                    ...
                    if (DEBUG_LAYOUT) {
                        String measureString = (childExtra > 0) ? ("(" + child.getMeasuredWidth() + "," + child.getMeasuredHeight() + ")") : "No new result";
                        Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 2-2: " + i + ", " +
                                             "measure result = " + measureString + ", " + "child = " + child + ", this = " + this);
                }
            }
        }

            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.2-2, maxWidth = " + maxWidth + ", " +
                                    "weightedMaxWidth = " + weightedMaxWidth + ", alternativeMaxWidth = " + alternativeMaxWidth + ", " +
                                    "mTotalLength = " + mTotalLength + ", this = " + this);
        ...
        if (matchWidth) {
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] +" + level + ", pass.3, Force uniform width, uniformWidth = " + getMeasuredWidth() + ", this = " + this);
            }

            forceUniformWidth(count, heightMeasureSpec);

            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.3, this = " + this);
            }
        }
    }
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG_LAYOUT) {
            level = getCurrentLevel();
            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] +" + level + ", pass.1 (Horizontal), this = " + this);
        }
        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (widthMode == MeasureSpec.EXACTLY && lp.width == 0 && lp.weight > 0) {
                ...
                if (baselineAligned) {
                    ...
                    if (DEBUG_LAYOUT) {
                        Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 1-1: " + i + ", " +
                                             "Measured(BaselineAligned), mTotalLength = " + mTotalLength + ", totalWeight = " + totalWeight + ", child = " + child + ", this = " + this);
                    }
                } else {
                    if (DEBUG_LAYOUT) {
                        Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 1-1: " + i + ", " +
        ...
        if (DEBUG_LAYOUT) {
            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.1, maxHeight = " + maxHeight + ", " +
                                 "weightedMaxHeight = " + weightedMaxHeight + ", alternativeMaxHeight = " + alternativeMaxHeight + ", " +
                                 "mTotalLength = " + mTotalLength + ", this = " + this);
        }
        ...
        if (useLargestChild &&
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.1.5 (Horizontal), Use largest child, largestChildWidth = " + largestChildWidth + ", mTotalLength = " + mTotalLength + ", this = " + this);
            }
        }
        ...
        if (DEBUG_LAYOUT) {
            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] +" + level + ", pass.2 (Horizontal), delta = " + delta + ", widthSize = " + widthSize + ", mTotalLength = " + mTotalLength + ", " +
                                 "padding (L,R,T,B) = " + mPaddingLeft + "," + mPaddingRight + "," + mPaddingTop + "," + mPaddingBottom + ", " + "this = " + this);
        }
        ...
        if (delta != 0 && totalWeight > 0.0f) {
                ...
                if (childExtra > 0) {
                    ...
                    if ((lp.width != 0) || (widthMode != MeasureSpec.EXACTLY)) {
                        ...
                        if (DEBUG_LAYOUT) {
                            Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", child 2-1-1: " + i + ", " +
                                                 "measure result = (" + child.getMeasuredWidth() + "," + child.getMeasuredHeight() + "), " +
                                                 "share = " + share + ", childWidth = " + childWidth + ", mTotalLength = " + mTotalLength + ", " + "child = " + child + ", this = " + this);
                        }
                    } else {
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.2-1, maxHeight = " + maxHeight + ", " +
                                    "weightedMaxHeight = " + weightedMaxHeight + ", alternativeMaxHeight = " + alternativeMaxHeight + ", " +
                                    "mTotalLength = " + mTotalLength + ", this = " + this);
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] -" + level + ", pass.2-2, maxHeight = " + maxHeight + ", " +
                                    "weightedMaxHeight = " + weightedMaxHeight + ", alternativeMaxHeight = " + alternativeMaxHeight + ", " +
                                    "mTotalLength = " + mTotalLength + ", this = " + this);
            }
        }
        ...
        if (matchHeight) {
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[LinearLayout] +" + level + ", pass.3 (Horizontal), Force uniform height, uniformHeight = " + getMeasuredHeight() + ", this = " + this);
            }
