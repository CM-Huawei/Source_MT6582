...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher,
    ...
    public boolean performItemClick(View view, int position, long id) {
        ...
        Xlog.d(TAG, "performItemClick view=" + view + ", position=" + position + ", id=" + id
    ...
    public void setOnScrollListener(OnScrollListener l) {
        Xlog.d(TAG, "setOnScrollListener: OnScrollListener=" + l + ", this=" + this);
        mOnScrollListener = l;
    ...
    void resetList() {
        ...
        if (sDbgSelector) {
            Xlog.d(TAG, "mSelectorRect.setEmpty in resetList this=" + this, new Throwable("resetList"));
        }
        invalidate();
    }
    ...
    View obtainView(int position, boolean[] isScrap) {
        ...
        if (scrapView != null) {
            ...
            if (nowTime - logTime > DBG_TIMEOUT_VALUE) {
                Xlog.d(TAG, "[ANR Warning] getView time too long, adapter = " + mAdapter + ", position = " + position +
                    ", child = " + child + ", time = " + (nowTime - logTime));
            }
    ...
    private void positionSelector(int l, int t, int r, int b) {
        ...
        if (sDbgSelector) {
            Xlog.d(TAG, "mSelectorRect.set in positionSelector (" + mSelectorRect.left + ", " + mSelectorRect.top + ", " +
                              mSelectorRect.right + ", " + mSelectorRect.bottom + "), this=" + this, new Throwable("positionSelector"));
        }
    }
    ...
    private void drawSelector(Canvas canvas) {
        if (sDbgSelector) {
            Xlog.d(TAG, "drawSelector (" + mSelectorRect.left + ", " + mSelectorRect.top + ", " +
                              mSelectorRect.right + ", " + mSelectorRect.bottom + "), this=" + this);
            /// M: For debugging, don't draw selector to check whether the highlight is drawn by AbsListView
            if (sDbgDraw) {
                return;
            }
        }
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        Xlog.d(TAG, "onWindowFocusChanged: hasWindowFocus=" + hasWindowFocus + ", this=" + this);
    ...
    private class PerformClick extends WindowRunnnable implements Runnable {
        ...
        public void run() {
            ...
            if (!mDataChanged && isAttachedToWindow() && adapter != null && mItemCount > 0 &&
            ...
            Xlog.d(TAG, "PerformClick error mDataChanged=" + mDataChanged + ", isAttachedToWindow=" + isAttachedToWindow() + ", adapter=" + adapter
                    + ", mItemCount=" + mItemCount + ", motionPosition=" + motionPosition + ", sameWindow=" + sameWindow());
    ...
    public void draw(Canvas canvas) {
        ...
        if (mEdgeGlowTop != null) {
            ...
            if (!mEdgeGlowTop.isFinished()) {
                ...
                /// M: clip to avoid EdgeEffect draw over content bounds
                canvas.clipRect(leftPadding, 0, getWidth() - rightPadding, getHeight());
    ...
    public boolean onInterceptHoverEvent(MotionEvent event) {
        if (sDbgMotion) {
            Xlog.d(TAG, "onInterceptHoverEvent: mFastScroller = " 
    ...
    void reportScrollStateChange(int newState) {
        Xlog.d(TAG, "reportScrollStateChange: newState=" + newState + ", mLastScrollState=" + mLastScrollState
    ...
    private class FlingRunnable implements Runnable {
        ...
        public void run() {
            ...
            case TOUCH_MODE_FLING: {
                ...
                if (sDbgMotion) {
                    Xlog.d(TAG, "FlingRunnable mode = " + mTouchMode + " mScrollY = " + mScrollY
    ...
    boolean trackMotionScroll(int deltaY, int incrementalDeltaY) {
        ...
        if (!inTouchMode && mSelectedPosition != INVALID_POSITION) {
            ...
            mSelectorRect.setEmpty();
            if (sDbgSelector) {
                Xlog.d(TAG, "mSelectorRect.setEmpty in trackMotionScroll this=" + this, new Throwable("trackMotionScroll"));
            }
        }
        ...
        void addScrapView(View scrap, int position) {
            ...
            if (scrapHasTransientState) {
                ...
                /// M: OOM warning, too many scrap view
				            if (scrapsCount > 0 && scrapsCount % DBG_OOM_VALUE == 0) {
				                Xlog.d(TAG, "[OOM warning] total=" + scrapsCount + ", scrap=" + scrap + ", position=" + position
				                        + ", scrap width=" + scrap.getMeasuredWidth() + ", height="
				                        + scrap.getMeasuredHeight() + ",mViewTypeCount = " + mViewTypeCount
				                        + ", viewType = " + viewType + ",this = " + this);
				            }
    ...
    boolean setDataChanged(boolean changed) {
        final boolean ret = super.setDataChanged(changed);

        if (sDbgDataChange && ret) {
            int countFromAdapter = -1;
            if (mAdapter != null) {
                countFromAdapter = mAdapter.getCount();
            }
            Xlog.d(TAG, "setDataChanged changed=" + changed
                      + ", mOldItemCount=" + mOldItemCount
                      + ", mItemCount=" + mItemCount
                      + ", countFromAdapter=" + countFromAdapter
                      + ", mAdapter=" + mAdapter
                      + ", this=" + this
