...
public class RelativeLayout extends ViewGroup {
    ...
    /// M: Flag for indicating enable or disable log debugging.
    private static boolean DEBUG_RULE = false;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG_LAYOUT) {
            ...
            Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout][onMeasure] +" + level + ", " +
        ...
        if (isLayoutRtl() && myWidth == -1) {
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] -" + level + ", pass.1 (RtL), myWidth=" + myWidth + ", myHeight" + myHeight + "this = " + this);
            }
        }
        ...
        if (DEBUG_LAYOUT) {
            Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] +" + level + ", pass.2 (Horizontal), this= " + this);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] +" + level + ", child 2: " + i + ", " + "child = " + child + ", this = " + this);
                }
                LayoutParams params = (LayoutParams) child.getLayoutParams();
                int[] rules = params.getRules(layoutDirection);

                if (DEBUG_RULE) {
                    Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] +" + level + ", child_horizontal: i = " + i + ", " +
                                         "params(L,R,T,B) = " + params.mLeft + "," + params.mRight + "," + params.mTop + "," + params.mBottom + ", " +
                                         "params(width,height) = " + params.width + " , " + params.height  + ", " + "child = " + child + ", this = " + this);
                }
                applyHorizontalSizeRules(params, myWidth, rules);
                if (DEBUG_RULE) {
                    Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] -" + level + ", child_horizontal: i = " + i + ", " +
                                         "params(L,R,T,B) = " + params.mLeft + "," + params.mRight + "," + params.mTop + "," + params.mBottom + ", " + "child = " + child + ", this = " + this);
                }
                ...
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] -" + level + ", child 2: " + i + ", " +
                                         "measure result = (" + child.getMeasuredWidth() + "," + child.getMeasuredHeight() + "), " + "child = " + child + ", this = " + this);
                }
            }
        }
        ...
        if (DEBUG_LAYOUT) {
           Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] +" + level + ", pass.3 (Vertical), this= " + this);
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] +" + level + ", child 3: " + i + ", " + "child = " + child + ", this = " + this);
                }
                LayoutParams params = (LayoutParams) child.getLayoutParams();
                
                if (DEBUG_RULE) {
                    Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] +" + level + ", child_vertical: i = " + i + ", " +
                                         "params(L,R,T,B) = " + params.mLeft + "," + params.mRight + "," + params.mTop + "," + params.mBottom + ", " +
                                         "params(width,height) = " + params.width + " , " + params.height  + ", " + "child = " + child + ", this = " + this);
                }
                ...
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] -" + level + ", child 3: " + i + ", " +
                                         "measure result = (" + child.getMeasuredWidth() + "," + child.getMeasuredHeight() + "), " + "child = " + child + ", this = " + this);
                }
            }
        }
        ...
        if (DEBUG_LAYOUT) {
            Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] -" + level + ", pass.3 (Vertical), " +
                                "width = " + width + ", height = " + height + ", " +
                                "left = " + left + ", right = " + right + ", " + "top = " + top + ", bottom = " + bottom + ", " + "this= " + this);
        ...
        if (mHasBaselineAlignedChild) {
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] " + level + ", pass.4 (HasBaselineAlignedChild), " +
                                    "left = " + left + ", right = " + right + ", " + "top = " + top + ", bottom = " + bottom + ", " + "this= " + this);
        ...
        if (isWrapContentWidth) {
            ...
            if (DEBUG_LAYOUT) {
               Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] -" + level + ", pass.5 (WrapContentWidth), " +
        ...
        if (isWrapContentHeight) {
            ...
            if (DEBUG_LAYOUT) {
                Xlog.d(DEBUG_LOG_TAG,"[RelativeLayout] -" + level + ", pass.6 (WrapContentHeight), " +
                                    "width = " + width + ", height = " + height + ", " + "this = " + this);
    ...
    private void initRelativeLayout() {
        ...
        DEBUG_RULE = SystemProperties.getBoolean(DEBUG_RULE_PROPERTY, false);
    }
