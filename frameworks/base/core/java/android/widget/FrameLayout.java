...
public class FrameLayout extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG_LAYOUT) {
            ...
            Xlog.d(DEBUG_LOG_TAG,"[FrameLayout][onMeasure] +" + level + ", " +
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (mMeasureAllChildren || child.getVisibility() != GONE) {
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[FrameLayout] +" + level + ", child 1: " + i + ", " + "child = " + child + ", this = " + this);
                }
                ...
                if (DEBUG_LAYOUT) {
                    Log.d(DEBUG_LOG_TAG,"[FrameLayout] -" + level + ", child 1: " + i + ", " +
        ...
        if (DEBUG_LAYOUT) {
            Log.d(DEBUG_LOG_TAG,"[FrameLayout] -" + level + ", pass.1, maxWidth = " + maxWidth + ", maxHeight = " + maxHeight + ", this = " + this);
        }
        ...
        if (count > 1) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (DEBUG_LAYOUT) {
                    Xlog.d(DEBUG_LOG_TAG,"[FrameLayout] +" + level + ", child 2: " + i + ", " + "child = " + child + ", this = " + this);
                }
                ...
                if (DEBUG_LAYOUT) {
                    Log.d(DEBUG_LOG_TAG,"[FrameLayout] -" + level + ", child 2: " + i + ", " +
                                        "measure result = (" + child.getMeasuredWidth()+ "," + child.getMeasuredHeight() + "), " + "child = " + child + ", this = " + this);
                }
            }
