...
public final class ViewRootImpl implements ViewParent,
    ...
    /// M: If Window size change, we need to do full draw phase(measure/layout/draw) when stop.
    private boolean mRequestLayoutByResize;
    ...
    private void performTraversals() {
        ...
        /// M: if Window resiszed, we should do measure.
        boolean layoutRequested = mLayoutRequested && !mStopped || mRequestLayoutByResize;
        if (layoutRequested) {
        ...
        if (mFirst || windowShouldResize || insetsChanged ||
            ...
            // M: if Window resiszed, we should do measure again because of size not match.
            if (!mStopped || mRequestLayoutByResize) {
        ...
        /// M: if Window resiszed, we should do layout.
        final boolean didLayout = layoutRequested && !mStopped || mRequestLayoutByResize;
        /// M: reset mRequestLayoutByResize
        mRequestLayoutByResize = false;
