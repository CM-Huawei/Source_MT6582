        ...
        VolumeController
{
    ...
    /// M: ALPS00907684:Menu icon in volume bar still display default color after change theme setting. @{
    ...
    private enum StreamResources {
        ...
        SystemStream(AudioManager.STREAM_SYSTEM,
                ...
                R.drawable.ic_audio_vol_mute,
                false),
        DtmfStream(AudioManager.STREAM_DTMF,
                R.string.volume_unknown,
                R.drawable.ic_audio_vol,
                R.drawable.ic_audio_vol_mute,
                false);
    ...
    private void listenToRingerMode() {
        ...
        mContext.registerReceiver(new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                } else if (FeatureOption.MTK_SMARTBOOK_SUPPORT && Intent.ACTION_SMARTBOOK_PLUG.equals(action)) {
                  ///M: for theme manager feature 
                    /// M: ALPS00907684: Menu icon in volume bar still display default color after change theme setting. @{
                    LayoutInflater inflater = (LayoutInflater) context
                         .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                    ...
                    /// M:ALPS01023704:It should not show MoreButton when mShowConbinedVolumes is false.
                    if (!mShowCombinedVolumes) {
                        mMoreButton.setVisibility(View.GONE);
                        mDivider.setVisibility(View.GONE);
                    } else {
                        mMoreButton.setOnClickListener(VolumePanel.this);
                    }
                    /// @} CR ALPS01023704
                    ...
                    if (FeatureOption.MTK_SMARTBOOK_SUPPORT && Intent.ACTION_SMARTBOOK_PLUG.equals(action)) {
                        if (mDialog.isShowing()) {
                            forceTimeout();
                        }
                    }
    ...
    private void updateSlider(StreamControl sc) {
         ...
         */
        if(sc.streamType == AudioManager.STREAM_BLUETOOTH_SCO || sc.streamType == AudioManager.STREAM_VOICE_CALL) {
            index++;
        } 
        ...
        if ((flags & AudioManager.FLAG_SHOW_UI) != 0 || mDialog.isShowing()) {
            synchronized (sConfirmSafeVolumeLock) {
                ...
                sConfirmSafeVolumeDialog = new AlertDialog.Builder(mContext)
                        ...
                        .setTitle(com.mediatek.internal.R.string.safe_media_volume_warning_title)
                        .create();
