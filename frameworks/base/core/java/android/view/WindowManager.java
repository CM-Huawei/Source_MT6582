...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams
         ...
         * @hide
         */
        public static final int TYPE_TOP_MOST = FIRST_SYSTEM_WINDOW+31;
        ...
        * to the window.
        ...
        /**
         * Specific flags for S3D mode. That is, enabling 3D and its layout type.
         * If not set, the default value of flagsEx will be unknown
         * Format :
         * ---------------------------------------------------------------------
         * |23	 | 22 - 21 |    20   |   19    |    18    |     17    |  16    |
         * |swap |  split  | unknown | display | reserved | no margin | no GIA |
         * ---------------------------------------------------------------------
         * [swap]
         *     0: N/A
         *     1: LR swapped (default L image is left half for SBS, and top half for TAB)
         * [split]
         *     00: NORMAL (2D)
         *     01: SBS
         *     10: TAB
         ...
         * [unknown]
         *     0: N/A
         *     1: surface layout unknown, let buffer decides
         * [display]
         *     0: 2D
         *     1: 3D
         *
         ...
         * 
         * [no margin]
         *     0: reserve black margin aftern offset adjustment
         *     1: no margin, and scale to fill
         *
         * [no GIA]
         *     0: use GIA for auto depth offset adjustment
         *     1: no use GIA
         */
        /** @hide */
        public static final int FLAG_EX_S3D_MASK           = 0x00FF0000;

        /** @hide */
        public static final int FLAG_EX_S3D_UNKNOWN        = 0x00100000;
        /** @hide */
        public static final int FLAG_EX_S3D_SIDE_BY_SIDE   = 0x00200000;
        /** @hide */
        public static final int FLAG_EX_S3D_TOP_AND_BOTTOM = 0x00400000;
        /** @hide */
        public static final int FLAG_EX_S3D_LR_SWAPPED     = 0x00800000;

        /** @hide */
        public static final int FLAG_EX_S3D_2D             = 0x00000000;
        /** @hide */
        public static final int FLAG_EX_S3D_3D             = 0x00080000;
        /** @hide */
        public static final int FLAG_EX_S3D_NO_GIA         = 0x00010000;
        /** @hide */
        public static final int FLAG_EX_S3D_NO_MARGIN      = 0x00020000;

        // BYTE#1 no use now

        // BYTE#0 for S3D manual offset settings
        /** @hide */
        public static final int FLAG_EX_S3D_OFFSET_MANUAL_VALUE_MASK = 0x000000FF;
        /** @hide */
        public static final int FLAG_EX_S3D_OFFSET_MANUAL_VALUE_ZERO = 0x0000007F;

        // for surface init
        /** @hide */
        public static final int FLAG_EX_INIT_VALUE = FLAG_EX_S3D_UNKNOWN | FLAG_EX_S3D_OFFSET_MANUAL_VALUE_ZERO;
        /** @hide */
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            /// M: Add new flagsEx into LayoutParams
        ...
        /** {@hide} */
        /// M: When flagsEx has been changed, the flag is set.
        public static final int PRIVATE_FLAGS_EX_CHANGED = 1<<20;
        /** {@hide} */
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            /** M: Stereo3D @{ */
            /// M: Add new flagsEx into LayoutParams @{
            if (flagsEx != o.flagsEx) {
                flagsEx = o.flagsEx;
                changes |= PRIVATE_FLAGS_EX_CHANGED;
            }
            /// @}
        ...
        public String toString() {
            ...
            /// M: Add new flagsEx into LayoutParams @{
            if (flagsEx != FLAG_EX_S3D_UNKNOWN) {
                sb.append(" flagsEx=");
                sb.append(Integer.toHexString(flagsEx));
            }
            /// @}
