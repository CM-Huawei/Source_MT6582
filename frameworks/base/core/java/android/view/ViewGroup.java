...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
    ...
    /// M: for debug that child may be null
    private static final boolean DBG_CHILD_NULL = SystemProperties.getBoolean(
            "debug.view.childNulllog", false);
    /// M: for debug that child may be null
    ...
    private static final boolean DEBUG_LAYOUT_VIEWGROUP = SystemProperties.getBoolean(DEBUG_LAYOUT_VIEWGROUP_PROPERTY, false);
    ...
    public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
        ...
        if (descendantFocusability != FOCUS_BLOCK_DESCENDANTS) {
            ...
            try {
                ...
                Log.e(TAG, "child Null 1, this = " + this , new Throwable("addFocusables"));
                throw e;
            } finally {
                mInWorking = false;
            }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if ((mPrivateFlags & (PFLAG_FOCUSED | PFLAG_HAS_BOUNDS))
            ...
            if (DBG_KEY) {
                    Xlog.d(TAG, "dispatchKeyEvent to focus child event = " + event + ", mFocused = "
                    + mFocused + ",this = " + this);
            }
        ...
        if ((flags & FLAG_USE_CHILD_DRAWING_ORDER) == 0) {
            for (int i = 0; i < count; i++) {
                ...
                try {
                    ...
                    Log.e(TAG, "child Null 3, this = " + this , new Throwable("addFocusables"));
                    throw e;
                } finally {
                    mInWorking = false;
                }
            ...
            for (int i = 0; i < count; i++) {
                ...
                try {
                    ...
                    Log.e(TAG, "child Null 4, this = " + this , new Throwable("addFocusables"));
                    throw e;
                } finally {
                    mInWorking = false;
                }
    ...
    private void addViewInner(View child, int index, LayoutParams params,
        ...
        if (mAttachInfo != null && mAttachInfo.mViewRootImpl != null){
            if (mAttachInfo.mViewRootImpl.mThread != Thread.currentThread()) {
                Xlog.d(TAG, "Potential JE Warning : add child not at UI thread, this = " + this + "call stack =", new Throwable("addViewInner"));
            }
        }
    ...
    private void addInArray(View child, int index) {
        /// M: for debug that child may be null
        if (mInWorking) {
            Xlog.d(TAG, "addInArray been called, this = " + this + "call stack =", new Throwable("addInArray"));
        }
        View[] children = mChildren;
        final int count = mChildrenCount;
        ...
        /// M: Check all child is valid
        if (DBG_CHILD_NULL) {
            final int count2 = mChildrenCount;
            for (int i = 0; i < count2; i++) {
                final View child2 = children[i];
                if (child2 == null) {
                    Xlog.d(TAG, "addInArray: i = " + i + ",count = " + count2 + ", this = " + this, new Throwable("addInArray"));
                }
            }
        }
    ...
    private void removeFromArray(int index) {
        ...
        /// M: for debug that child may be null
        if (mInWorking) {
            Xlog.d(TAG, "removeFromArray been called, this = " + this + "call stack =", new Throwable("removeFromArray"));
        }
        ...
        if (DBG_CHILD_NULL) {
            ...
            for (int i = 0; i < count2; i++) {
                final View child = children[i];
                if (child == null) {
                    Xlog.d(TAG, "removeFromArray: i = " + i + ",count = " + count2 + ", this = " + this, new Throwable("removeFromArray"));
                }
            }
        }
    }
    ...
    private void removeFromArray(int start, int count) {
        ...
        /// M: for debug that child may be null
        if (mInWorking) {
            Xlog.d(TAG, "removeFromArray been called2, this = " + this + "call stack =", new Throwable("removeFromArray"));
        }
        ...
        if (DBG_CHILD_NULL) {
            ...
            for (int i = 0; i < count2; i++) {
                final View child = children[i];
                if (child == null) {
                    Xlog.d(TAG, "removeFromArray2: i = " + i + ",count = " + count2 + ", this = " + this, new Throwable("removeFromArray2"));
                }
            }
        }
    }
    ...
    private void removeViewInternal(int index, View view) {
        ...
        if (mAttachInfo != null && mAttachInfo.mViewRootImpl != null){
            if (mAttachInfo.mViewRootImpl.mThread != Thread.currentThread()) {
                Xlog.d(TAG, "Potential JE Warning : remove child not at UI thread, this = " + this + "call stack =", new Throwable("removeViewInternal"));
            }
        }
    ...
    public void removeAllViewsInLayout() {
        ...
        if (mAttachInfo != null && mAttachInfo.mViewRootImpl != null){
            if (mAttachInfo.mViewRootImpl.mThread != Thread.currentThread()) {
                Xlog.d(TAG, "Potential JE Warning : remove child not at UI thread, this = " + this + "call stack =", new Throwable("removeAllViewsInLayout"));
            }
        }
        ...
        /// M: for debug that child may be null
        if (mInWorking) {
            Xlog.d(TAG, "removeAllViewsInLayout been called, this = " + this + "call stack =", new Throwable("removeAllViewsInLayout"));
        }
    ...
    protected void detachAllViewsFromParent() {
        ...
        /// M: for debug that child may be null
        if (mInWorking) {
            Xlog.d(TAG, "detachAllViewsFromParent been called, this = " + this + "call stack =", new Throwable("detachAllViewsFromParent"));
        }
    ...
    protected void measureChild(View child, int parentWidthMeasureSpec,
        ...
        if (DEBUG_LAYOUT_VIEWGROUP) {
            ...
            Xlog.d(DEBUG_LOG_TAG,"[ViewGroup][measureChild] +" + level + ", child = " + child + ", " +
                                 "child params (width, height) = " + lp.width + "," + lp.height + ", " +
                                 "parent padding (L,R,T,B) = " + mPaddingLeft + "," + mPaddingRight + "," + mPaddingTop + "," + mPaddingBottom + ", " +
                                 "this = " + this);
        }
        child.measure(childWidthMeasureSpec, childHeightMeasureSpec);
        if (DEBUG_LAYOUT_VIEWGROUP) {
            Xlog.d(DEBUG_LOG_TAG,"[ViewGroup][measureChild] -" + level + ", child = " + child + ", this = " + this);
        }
    }
    ...
    protected void measureChildWithMargins(View child,
        ...
        if (DEBUG_LAYOUT_VIEWGROUP) {
            level = getCurrentLevel();
            Xlog.d(DEBUG_LOG_TAG,"[ViewGroup][measureChildWithMargins] +" + level + " , child = " + child + ", " +
                                 "child margin (L,R,T,B) = " + lp.leftMargin + "," + lp.rightMargin + "," + lp.topMargin + "," + lp.bottomMargin + ", " +
                                 "widthUsed = " + widthUsed + "heightUsed = " + heightUsed + ", " +
                                 "parent padding (L,R,T,B) = " + mPaddingLeft + "," + mPaddingRight + "," + mPaddingTop + "," + mPaddingBottom + ", " +
                                 "this = " + this);
        }
        child.measure(childWidthMeasureSpec, childHeightMeasureSpec);
        if (DEBUG_LAYOUT_VIEWGROUP) {
            Xlog.d(DEBUG_LOG_TAG,"[ViewGroup][measureChildWithMargins] -" + level + ", child = " + child + ", this = " + this);
        }
    }
        ...
        if (result) {
            ...
            try {
                for (int i = 0; i < count; i++) {
                 ...
                 Log.e(TAG, "child Null 2, this = " + this, new Throwable("resolveRtlPropertiesIfNeeded"));
                 throw e;
            } finally {
                mInWorking = false;
            }
