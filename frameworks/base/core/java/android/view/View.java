...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    */
    ...
    void handleFocusGainInternal(int direction, Rect previouslyFocusedRect) {
        ...
        if (DBG_FOCUS){
            Xlog.d(VIEW_LOG_TAG, "handleFocusGainInternal: this = " + this + ", callstack = " ,new Throwable("ViewFocus"));
        }
    ...
    public void clearFocus() {
        ...
        if (DBG_FOCUS){
            Xlog.d(VIEW_LOG_TAG, "clearFocus: this = " + this);
        }
    ...
    void unFocus() {
        ...
        if (DBG_FOCUS){
            Xlog.d(VIEW_LOG_TAG, "unFocus: this = " + this);
        }
    ...
    */
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN){
            Xlog.i(VIEW_LOG_TAG, "Key down dispatch to " + this + ", event = " + event);
        }
        ...
        if (li != null && li.mOnKeyListener != null && (mViewFlags & ENABLED_MASK) == ENABLED
            ...
            if (DBG_KEY) {
                Xlog.d(VIEW_LOG_TAG, "handle Key event by listerner, listener = " + li + ", event = "
                    + event + ", this = " + this);
            }
            return true;
        }
        ...
        if (event.dispatch(this, mAttachInfo != null
            ...
            /// M : add log to help debugging
            if (DBG_KEY) {
                Xlog.d(VIEW_LOG_TAG, "handle Key event by onXXX, event = "
                    + event + ", this = " + this);
            }
            return true;
        }
        /// M : add log to help debugging
        if (DBG_KEY) {
            Xlog.d(VIEW_LOG_TAG, "Do not handle key event, event = "
            + event + ", this = " + this);
        }
   ...
   /**
    ...
    public void invalidate(Rect dirty) {
        if (DBG_DRAW) {
             Xlog.d(VIEW_LOG_TAG, "View invalidate: this = " + this + ", dirty" + dirty + ", call stack 3 = " + Debug.getCallers(3));
        }
        if (skipInvalidate()) {
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "View invalidate: skipInvalidate , this = " + this);
            }
            return;
        }
        if ((mPrivateFlags & (PFLAG_DRAWN | PFLAG_HAS_BOUNDS)) == (PFLAG_DRAWN | PFLAG_HAS_BOUNDS) ||
            ...
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "View invalidate: Do not invalidate , this = " + this
                    + ", mPrivateFlags = " + mPrivateFlags + ", isOpaque = " + isOpaque()
                    + ", mLastIsOpaque = " + mLastIsOpaque);
            }
        }
    }
    ...
    public void invalidate(int l, int t, int r, int b) {
        if (DBG_DRAW) {
             Xlog.d(VIEW_LOG_TAG, "View invalidate: this = " + this + ", l =" + l + ", t =" + t
                + ", r =" + r + ", b =" + b + ", call stack 3 = " + Debug.getCallers(3));
        }
        if (skipInvalidate()) {
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "View invalidate: skipInvalidate , this = " + this);
    ...
    void invalidate(boolean invalidateCache) {
        if (DBG_DRAW) {
             Xlog.d(VIEW_LOG_TAG, "View invalidate: this = " + this + ", invalidateCache" + invalidateCache + ", call stack 3 = " + Debug.getCallers(3));
        }
        if (skipInvalidate()) {
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "View invalidate: skipInvalidate , this = " + this);
    ...
    public void setLayerType(int layerType, Paint paint) {
        ...
        if (DBG_DRAW) {
            Xlog.d(VIEW_LOG_TAG, "setLayerType, this =" + this + ", layerType = "
    ...
    boolean destroyLayer(boolean valid) {
        if (mHardwareLayer != null) {
            ...
            if (info != null && info.mHardwareRenderer != null
                    && (info.mHardwareRenderer.isEnabled() || HardwareRenderer.forceDestroyLayers())
    ...
    private DisplayList getDisplayList(DisplayList displayList, boolean isLayer) {
        ...
        if (((mPrivateFlags & PFLAG_DRAWING_CACHE_VALID) == 0 ||
            ...
            /// M: name for displaylist and systrace
            final String name = getClass().getSimpleName() + " @" + Integer.toHexString(this.hashCode());
            ...
            if (displayList != null && displayList.isValid() &&
                ...
                if (DBG_DRAW) {
                    Xlog.d(VIEW_LOG_TAG, "getDisplayList : do not dirty itself only dispatch getDisplaylist to child,this = " + this);
                }
                Trace.traceBegin(Trace.TRACE_TAG_HWUI, name);
            ...
            try {
                if (!isLayer && layerType != LAYER_TYPE_NONE) {
                    ...
                    if ((mPrivateFlags & PFLAG_SKIP_DRAW) == PFLAG_SKIP_DRAW) {
                        if (DBG_DRAW) {
                            Xlog.d(VIEW_LOG_TAG, "getDisplayList : calling dispatchDraw,this = " + this);
                        }
                        dispatchDraw(canvas);
                        ...
                        if (DBG_DRAW) {
                            Xlog.d(VIEW_LOG_TAG, "getDisplayList : calling draw,this = " + this);
                        }
                        draw(canvas);
                    }
                }
        ...
        if (DBG_DRAW) {
            Xlog.d(VIEW_LOG_TAG, "getDisplayList : return displayList,this = " + this);
        }
    ...
    public void buildDrawingCache(boolean autoScale) {
        if ((mPrivateFlags & PFLAG_DRAWING_CACHE_VALID) == 0 || (autoScale ?
            ...
            if ((mPrivateFlags & PFLAG_SKIP_DRAW) == PFLAG_SKIP_DRAW) {
                mPrivateFlags &= ~PFLAG_DIRTY_MASK;
                if (DBG_DRAW) {
                    Xlog.d(VIEW_LOG_TAG, "view buildDrawingCache : calling dispatchDraw,this = " + this);
                }
                dispatchDraw(canvas);
                if (mOverlay != null && !mOverlay.isEmpty()) {
                    mOverlay.getOverlayView().draw(canvas);
                ...
                if (DBG_DRAW) {
                    Xlog.d(VIEW_LOG_TAG, "view buildDrawingCache : calling draw,this = " + this);
                }
                draw(canvas);
            }
    ...
    boolean draw(Canvas canvas, ViewGroup parent, long drawingTime) {
        ...
        if (DBG_DRAW) {
            Xlog.d(VIEW_LOG_TAG, "view draw1, this =" + this + ", layerType = "
                + layerType + ", hardwareAccelerated = " + hardwareAccelerated
                + ", caching = " + caching);
        }
        ...
        if (hasNoCache) {
            ...
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "view draw1 : calling drawBitmap,this = " + this);
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (!verticalEdges && !horizontalEdges) {
            ...
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "view draw2 : calling onDraw,this = " + this);
            }
            ...
            if (DBG_DRAW) {
                Xlog.d(VIEW_LOG_TAG, "view draw2 : calling dispatchDraw,this = " + this);
            }
            dispatchDraw(canvas);
        ...
        if (solidColor == 0) {
            ...
            if (FADING_EDGE_ENHANCE) {
                if (drawTop || drawBottom || drawLeft || drawRight) {
                                final int flags = Canvas.HAS_ALPHA_LAYER_SAVE_FLAG | Canvas.CLIP_TO_LAYER_SAVE_FLAG;
                                canvas.saveLayer(mScrollX,
                                                 mScrollY,
        ...
        // Step 3, draw the content
        if (DBG_DRAW) {
            Xlog.d(VIEW_LOG_TAG, "view draw3 : calling onDraw,this = " + this);
        }
        /// M: Monitor onDraw time if longer than 3s print log.
        if (!dirtyOpaque) {
            long logTime = System.currentTimeMillis();
            ...
            long nowTime = System.currentTimeMillis();
            if (nowTime - logTime > DBG_TIMEOUT_VALUE) {
                Xlog.d(VIEW_LOG_TAG, "[ANR Warning]onDraw time too long, this =" + this + ", time =" + (nowTime - logTime) + " ms");
            }
        }

        // Step 4, draw the children
        if (DBG_DRAW) {
            Xlog.d(VIEW_LOG_TAG, "view draw3 : calling dispatchDraw,this = " + this);
        }
        dispatchDraw(canvas);
    ...
    public void layout(int l, int t, int r, int b) {
        ...
        if (DBG_LAYOUT) {
            Xlog.d(VIEW_LOG_TAG, "veiw layout start, this =" + this + ", mLeft = "
                + mLeft + ", mTop = " + mTop
                + ", mBottom = " + mBottom + ", mRight = "
                + mRight + ", changed =" + changed);
        }
        if (changed || (mPrivateFlags & PFLAG_LAYOUT_REQUIRED) == PFLAG_LAYOUT_REQUIRED) {
            ...
            if (DBG_LAYOUT) {
                Xlog.d(VIEW_LOG_TAG, "veiw layout end, this =" + this + ", mLeft = "
                    + mLeft + ", mTop = " + mTop
                    + ", mBottom = " + mBottom + ", mRight = "
                    + mRight + ", time =" + (nowTime - logTime) + " ms");
            }
    ...
    public void requestLayout() {
        ...
        if (DBG_LAYOUT) {
            Xlog.d(VIEW_LOG_TAG, "veiw request layout, this =" + this);
        }
