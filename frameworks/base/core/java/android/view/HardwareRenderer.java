...
public abstract class HardwareRenderer {
    /// M: add debug flag.
    private static boolean mDebugHwRenderer = false;
    static final String LOG_TAG = "HardwareRenderer";
    /// M: System property used to enable or disable log debugging.
    private static final String DEBUG_HWRENDERER_PROPERTY = "debug.hwrenderer.log";
    ...
    private static boolean sForceDestroyLayers;
     ...
     */
    public static boolean forceDestroyLayers() {
        if (mDebugHwRenderer) {
            Xlog.v(LOG_TAG, "forceDestroyLayers: sForceDestroyLayers = " + sForceDestroyLayers);
        }
        return sForceDestroyLayers;
    }
     ...
     */
    public static void setForceDestroyLayers(final boolean force) {
        if (mDebugHwRenderer) {
            Xlog.v(LOG_TAG, "setForceDestroyLayers: force = " + force + ",sForceDestroyLayers = " + sForceDestroyLayers);
        }
        sForceDestroyLayers = force;
    }
    ...
    static abstract class GlRenderer extends HardwareRenderer {
        ...
        static {
            /// M: Default is off, only switch on for compatible chips.
            String dirtyProperty = SystemProperties.get(RENDER_DIRTY_REGIONS_PROPERTY, "false");
        ...
        GlRenderer(int glVersion, boolean translucent) {
            ...
            setHWUIDebugLog(true);

            mDebugHwRenderer = SystemProperties.getBoolean(DEBUG_HWRENDERER_PROPERTY, false);
        }
        ...
        private Rect beginFrame(HardwareCanvas canvas, Rect dirty, int surfaceState) {
            Trace.traceBegin(Trace.TRACE_TAG_VIEW, "beginFrame");
    ...
    static class Gl20Renderer extends GlRenderer {
        ...
        void cancelLayerUpdate(HardwareLayer layer) {
            if (mGlCanvas != null) {
                ...
                Xlog.d(LOG_TAG, "CancelLayerUpdate while mGlCanvas is null, this = " + this);
            }
        }
