...
public class Notification implements Parcelable
{
    ...
    /// M: For showing SIM icon in front of notification piles
    /**
     * @hide
     * @internal
     * This is to show SIM icon in front of the notifcation piles which comes from a specific SIM.
     * 0-not shown.
     * 1-shown SIM icon at notification piles.
     * 2-shown SIM icon at status bar. No use now.
     * 3-shown SIM icon at both notification piles and status bar. Actually, only the notificaton piles will take effect.
     */
     ...
     * @hide
     * @internal
     * The SIM id for a given notification. The corresponding SIM icon for the given SIM id will be
     * displayed in front of notification piles.
     */
    public long simId;
