...
public interface IApplicationThread extends IInterface {
    ...
    int DUMP_MESSAGE_HISTORY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 51;     /// M: ALPS00270724 message history mechanism
    int ENABLE_LOOPER_LOG = IBinder.FIRST_CALL_TRANSACTION + 52;                    /// M: ActivityThread looper log enhancement
    int SET_TRIM_MEMORY_FLAG_EX = IBinder.FIRST_CALL_TRANSACTION+53;      /// M: ALPS00497111 [Volunteer free] LCA Memory Optimized
    int RESET_SL_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+54;                   /// M: ALPS00497111 [Volunteer free] LCA Memory Optimized
/// M: MSG HISTORY mechanism for SystemServer @{
    int DUMP_ALL_MESSAGE_HISTORY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 55;
///@}
}
