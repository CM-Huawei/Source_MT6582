    ...
    private static class DefaultHttpRequestCheckHandler implements HttpRequestCheckHandler{
        ...
        */
        private boolean checkMoMSSubPermission(String subPermission) {
           try {
                  ...
                  if (result != PackageManager.PERMISSION_GRANTED) {
                     Log.d(TAG, "[Error]Subpermission is not granted!!");
                     return false;
                  }
           } catch (Exception e) {
                  Log.e(TAG, "[Error]Failed to chcek permission: " +  subPermission);
                  return false;
           }
        ...
        public boolean checkRequest(HttpRequest request){
           ...
           return checkMoMSSubPermission(SubPermissions.SEND_MMS);
        }
    }
    ///@}
}
