...
public class DhcpResults implements Parcelable {
    ...
    public void clear() {
        ...
        vendorInfo = null;
        leaseDuration = 0;
        ppplinkname = null; //FIXME:this interfaceName are NOT the same as setInterfaceName
        pidForRenew =  0;
    }
    ...
    public String toString() {
        ...
        str.append(" ppplinkname ").append(ppplinkname); //FIXME: is here right?
    ...
    public static final Creator<DhcpResults> CREATOR =
        new Creator<DhcpResults>() {
            public DhcpResults createFromParcel(Parcel in) {
                ...
                prop.ppplinkname = in.readString();
                prop.pidForRenew = in.readInt();
                return prop;
            }
