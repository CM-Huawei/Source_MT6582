...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
     ...
     * Value for {@link #mtkFlags}: Set to true if the application is an operator app under
     * /vendor/operator/app or /cutomer/app
     *
     * {@hide}
     */
    public static final int FLAG_OPERATOR = 1<<0;
    ...
    public void dump(Printer pw, String prefix) {
        ...
        /** M: [FlagExt] Dump mtkFlags value @{ */
                + " mtkFlags=0x" + Integer.toHexString(mtkFlags));
        /** @} */
    ...
    public ApplicationInfo(ApplicationInfo orig) {
        ...
        theme = orig.theme;
        flags = orig.flags;
        /** M: [FlagExt] mtkFlags will copied in copy constructor @{ */
        mtkFlags = orig.mtkFlags;
        /** @} */
