...
public abstract class PackageManager {
    ...
    /**
     * Permission check result by user: this is returned by MoMS.checkPermission()
     * if the permission has been denied by user to the given package.
     * @hide
     */
    public static final int PERMISSION_USER_DENIED = -2;
