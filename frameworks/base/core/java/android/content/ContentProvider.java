...
public abstract class ContentProvider implements ComponentCallbacks2 {
    ...
    class Transport extends ContentProviderNative {
        // M: MoMS user checking
        IMobileManagerService mMobileManagerService = null;
        ...
        public Cursor query(String callingPkg, Uri uri, String[] projection,
            ...
            if (FeatureOption.MTK_MOBILE_MANAGEMENT) {
                ...
                String permission = getQueryPermission();
                if (permission != null) {
                    try {
                        int result = mMobileManagerService.checkPermission(permission, Binder.getCallingUid());
     ...
     * @hide
     */
    public final void setQueryPermission(String queryPermission) {
