...
public class Intent implements Parcelable, Cloneable {
   ...
   /** M:
    ...
    /**
     * M: Use to broadcast incoming call toggled when call switched
     * @hide
     *  @{ */
    ...
    /**
     * M: Indicate whether forbide international assist dialog  (PhoneAPP & Bluetooth)
     * @hide
     *  @{ */
    ...
    /**
     * M: For indicate whether is VT Call
     * @hide
     *  @{ */
