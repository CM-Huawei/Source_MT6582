...
public final class URLUtil {
    ...
    private static final Pattern BASE64_CONTENT_DISPOSITION_PATTERN =
            Pattern.compile("attachment;\\s*filename\\s*=\\s*(\"?)=\\?([a-zA-Z0-9-_]+)\\?B\\?([a-zA-Z0-9+/]*[=]{0,2})(\\?=)\\1\\s*$",
            Pattern.CASE_INSENSITIVE);
        ...
        try {
            ...
            if (m.find()) {
                try {
                    ...
                    Log.d(LOGTAG, "IOException: " + contentDisposition);
    ...
    static void testParseContentDisposition() {
        Log.d(LOGTAG, parseContentDisposition("attachment; filename=\"image001.jpg\""));                       // image001.jpg
        Log.d(LOGTAG, parseContentDisposition("attachment; filename=\"=?ISO-8859-1?B?aW1hZ2UwMDEuanBn?=\""));  // image001.jpg
        Log.d(LOGTAG, parseContentDisposition("attachment; filename=\"=?UTF-8?B?aW1hZ2UwMDEuanBn?=\""));       // image001.jpg
        Log.d(LOGTAG, parseContentDisposition("attachment; filename=\"=?GB2312?B?JWQ2JWQwJWNlJWM0JWJhJWJhJWQ3JWQ2?=\""));  // Chinese zhong wen han zi
    }
}
