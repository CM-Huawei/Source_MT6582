...
///M: add
   ...
   /**
    ...
    public boolean setPersistentReconnect(boolean enabled) {
        Log.d(mTAG, "setPersistentReconnect, enabled = " + enabled);
    ...
    public boolean setP2pGroupIdle(String iface, int time) {
        Log.d(mTAG, "setP2pGroupIdle, iface = " + iface + " time = " + time);
        synchronized (mLock) {
    ...
    public boolean setP2pPowerSave(String iface, boolean enabled) {
        Log.d(mTAG, "setP2pPowerSave, iface = " + iface + " enabled = " + enabled);
        synchronized (mLock) {
            if (enabled) {
    ...
    public boolean p2pFind(int timeout) {
        Log.d(mTAG, "p2pFind, timeout = " + timeout);
        if (timeout <= 0) {
            return p2pFind();
        }
    ...
    public String p2pConnect(WifiP2pConfig config, boolean joinExistingGroup) {
        Log.d(mTAG, "p2pConnect, joinExistingGroup = " + joinExistingGroup);
        ...
        Log.d(mTAG, "p2pConnect, config.netId = " + config.netId);
        ...
        Log.d(mTAG, "p2pConnect, command = " + command);
        
        return doStringCommand(command);
    }

    public boolean p2pCancelConnect() {
        Log.d(mTAG, "p2pCancelConnect");
        return doBooleanCommand("P2P_CANCEL");
    }

    public boolean p2pProvisionDiscovery(WifiP2pConfig config) {
        Log.d(mTAG, "p2pProvisionDiscovery");
    ...
    public boolean p2pGroupAdd(boolean persistent) {
        Log.d(mTAG, "p2pGroupAdd, persistent = " + persistent);
        if (persistent) {
    ...
    public boolean p2pGroupAdd(int netId) {
        Log.d(mTAG, "p2pGroupAdd, netId = " + netId);
        return doBooleanCommand("P2P_GROUP_ADD persistent=" + netId);
    }

    public boolean p2pGroupRemove(String iface) {
        Log.d(mTAG, "p2pGroupRemove, iface = " + iface);
    ...
    public boolean p2pReject(String deviceAddress) {
        Log.d(mTAG, "p2pReject, deviceAddress = " + deviceAddress);
        return doBooleanCommand("P2P_REJECT " + deviceAddress);
    }

    /* Invite a peer to a group */
    public boolean p2pInvite(WifiP2pGroup group, String deviceAddress) {
        Log.d(mTAG, "p2pInvite, deviceAddress = " + deviceAddress);
    ...
    public boolean p2pReinvoke(int netId, String deviceAddress) {
        Log.d(mTAG, "p2pReinvoke, netId = " + netId + " deviceAddress = " + deviceAddress);
    ...
    public String p2pPeer(String deviceAddress) {
        Log.d(mTAG, "p2pPeer, deviceAddress = " + deviceAddress);
    ...
    public void p2pBeamPlusGO(int reserve) {
        Log.d(mTAG, "p2pBeamPlusGO, reserve = " + reserve);
        if (0 == reserve) {
    ...
    public void p2pBeamPlus(int state) {
        Log.d(mTAG, "p2pBeamPlus, state = " + state);
        if (0 == state) {
    ...
    public boolean p2pSetBssid(int id, String bssid) {
        Log.d(mTAG, "p2pSetBssid, id = " + id + " bssid = " + bssid);
        if (mInterfaceName.equals("p2p0")) {
    ...
    public String p2pLinkStatics(String interfaceAddress) {
        Log.d(mTAG, "p2pLinkStatics, interfaceAddress = " + interfaceAddress);
    ...
    public int p2pAutoChannel(int enable) {
        Log.d(mTAG, "p2pAutoChannel, enable = " + enable);
