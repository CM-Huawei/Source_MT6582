...
class SupplicantStateTracker extends StateMachine {
    ...
    private void handleNetworkConnectionFailure(int netId, int disableReason) {
        ...
        ///M: MTk add
        mWifiStateMachine.notifyConnectionFailure();
    }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case WifiMonitor.AUTHENTICATION_FAILURE_EVENT:
                    ...
                    Xlog.d(TAG, "AUTHENTICATION_FAILURE_EVENT, mAuthenticationFailuresCount:"
                           + mAuthenticationFailuresCount);
                ...
                case WifiManager.CONNECT_NETWORK:
                    ...
                    mConnectNetworkId = (Integer)message.arg1;
                    mAssociationRejectCount = 0;
                    break;
                case WifiManager.FORGET_NETWORK:
                    if ((Integer)message.arg1 == mConnectNetworkId) {
