...
public class WifiP2pManager {
    ...
    ///M:@{
    /** @hide */
    public static final int REQUEST_LINK_INFO                       = BASE + 76;
    /** @hide */
    public static final int RESPONSE_LINK_INFO                      = BASE + 77;

    /** @hide */
    public static final int SET_AUTO_CHANNEL_SELECT                 = BASE + 78;
    /** @hide */
    public static final int SET_AUTO_CHANNEL_SELECT_FAILED          = BASE + 79;
    /** @hide */
    public static final int SET_AUTO_CHANNEL_SELECT_SUCCEEDED       = BASE + 80; 

    /** @hide */
    public static final int SET_WFD_SESSION_MODE                    = BASE + 81;
    /** @hide */
    public static final int SET_WFD_SESSION_MODE_FAILED             = BASE + 82;
    /** @hide */
    public static final int SET_WFD_SESSION_MODE_SUCCEEDED          = BASE + 83;  
   ...
   /**
    ...
    public void setDeviceName(Channel c, String devName, ActionListener listener) {
        Log.d(TAG, "setDeviceName, devName = " + devName);
        checkChannel(c);
    ...
    public void deletePersistentGroup(Channel c, int netId, ActionListener listener) {
        Log.d(TAG, "deletePersistentGroup, netId = " + netId);
        checkChannel(c);
    ...
    public void setMiracastMode(int mode) {
        Log.d(TAG, "setMiracastMode, mode = " + mode);
        try {
    ...
    /**
     * set wfd session mode
     *
     * @param c is the channel created at {@link #initialize}
     * @param state is the session mode willing to set, value is defined in 
     *  WifiP2pWfdInfo.java of package android.net.wifi.p2p
     * @param listener for callbacks on success or failure. Can be null.
     * @hide
     */
    public void setWfdSessionMode(Channel c, int state, ActionListener listener) {
        Log.d(TAG, "setWfdSessionMode, state = " + state);
        checkChannel(c);
        c.mAsyncChannel.sendMessage(SET_WFD_SESSION_MODE, state, c.putListener(listener));
    }
     ...
     * @hide
     */
    public void finalize(Channel c) {
        Log.i(TAG, "finalize()");
        checkChannel(c);
        //can't use this
