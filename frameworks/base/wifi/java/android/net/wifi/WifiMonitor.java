...
public class WifiMonitor {
    ...
    //M: add
    private static final int NO_CERTIFICATION = 11;
   ...
   /* Network connection completed */
    ...
    public static final int NEW_PAC_UPDATED_EVENT                = BASE + 52;
    ///M: whole chip reset fail 
    public static final int WHOLE_CHIP_RESET_FAIL_EVENT          = BASE + 53;
    ...
    private static class MonitorThread extends Thread {
        ...
        private P2pStatus p2pError(String dataString) {
            Log.d(TAG, "p2pError, dataString = " + dataString);
        ...
        private P2pStatus p2pError_GroupRemove(String dataString) {
            Log.d(TAG, "p2pError_GroupRemove, dataString = " + dataString);
            P2pStatus err = P2pStatus.UNKNOWN;
            String[] tokens = dataString.split(" ");
       ...
       ///@}
        ...
        private void handleP2pEvents(String dataString) {
            Log.d(TAG, "handleP2pEvents, dataString = " + dataString);
            if (dataString.startsWith(P2P_DEVICE_FOUND_STR)) {
                ...
                mStateMachine.sendMessage(P2P_GROUP_REMOVED_EVENT, p2pError_GroupRemove(dataString));
