...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    private static boolean DISABLE_TOUCH_INTERACTION = false;
    ...
    /// M: [ALPS00682011] always hide the challenge when page begin moving
    protected void pageContinueMoving() {
        onPageContinueMoving();
    }
    ...
    ///M: ALPS00682011 to hide challenge if continue to scroll pages before it stops
    /// a method that subclasses can override to add behavior
    protected void onPageContinueMoving(){
    }
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (finishedScrolling) {
                    ...
                    /// M: [ALPS00601720] do not abort animation to avoid animation stoped at rotating steps.
                    //mScroller.abortAnimation();
                } else {
    ...
    private void startScrolling(MotionEvent ev) {
        ...
        final float x = ev.getX(pointerIndex);
        /// M: setTouchState(TOUCH_STATE_SCROLLING);
        ...
        mSmoothingTime = System.nanoTime() / NANOTIME_DIV;
        ///M: ALPS00682011 to hide challenge if continue to scroll pages before it stops
        if (mTouchState == TOUCH_STATE_REST && mIsPageMoving) {
            pageContinueMoving();
        } else {
            pageBeginMoving();
        }
    ...
    public void setDisableTouchInteraction(boolean disable) {
        DISABLE_TOUCH_INTERACTION = disable ;
    }
