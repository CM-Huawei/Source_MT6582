...
public class KeyguardWidgetPager extends PagedView implements PagedView.PageSwitchListener,
    ...
    public void onPageSwitched(View newPage, int newPageIndex) {
        ...
        /// M: to disable clock if Widget clock is completely shown
        if (showingClock && mStatusWidgetIsCompletelyShown) {
        ...
        if (mPage != newPageIndex) {
            ...
            if (newWidgetPage != null) {
                ...
                /// M: [ALPS00844621] fix transportController alpha is 0 after set current page
                if (mChildrenOutlineFadeAnimation != null) {
                    mChildrenOutlineFadeAnimation.cancel();
                    mChildrenOutlineFadeAnimation = null;
                }
                newWidgetPage.setContentAlpha(1.0f);
    ...
    /// M: [ALPS01377762] Clean up resources
    public void cleanUp() {
        // Clean up the worker thread
        mBackgroundWorkerThread.quit();
    }
