...
public class KeyguardTransportControlView extends FrameLayout {
    ...
    /// M: for keyguard to set pause state when IPO shunt down
    public void setMusicPauseStateForIPO() {
        Log.i(TAG, "setMusicPauseStateForIPO shut down");
        updatePlayPauseState(RemoteControlClient.PLAYSTATE_PAUSED);
