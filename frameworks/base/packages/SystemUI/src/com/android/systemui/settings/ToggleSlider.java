...
public class ToggleSlider extends RelativeLayout
    ...
    public void hideToggle() {
        /// M: [ALPS01264124] Just disable the toggle.
        /// M: [ALPS01275329][KK] Hide the toggle and adjust layout.
        mToggle.setVisibility(View.INVISIBLE);
        mLabel.setVisibility(View.INVISIBLE);
        ViewGroup.LayoutParams vlp = mToggle.getLayoutParams();
        vlp.width = 0;
        mToggle.setLayoutParams(vlp);
    }
}
