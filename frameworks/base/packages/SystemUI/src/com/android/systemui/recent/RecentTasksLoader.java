...
public class RecentTasksLoader implements View.OnTouchListener {
    ...
    private boolean isCurrentHomeActivity(ComponentName component, ActivityInfo homeInfo) {
        /// M: [ALPS00846214] Check all installed launcher.
        ActivityInfo homeAI;
    ...
    public void loadTasksInBackground(final boolean zeroeth) {
        ...
        mTaskLoader = new AsyncTask<Void, ArrayList<TaskDescription>, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (DEBUG) Log.v(TAG, "numTask = " + numTasks);
        ...
        try {
            ...
            Log.d(TAG, "mTaskLoader.executeOnExecutor, rejecting execution ", e);
        }
    ...
    private void loadThumbnailsAndIconsInBackground(
        ...
        try {
            ...
            Log.d(TAG, "mThumbnailLoader.executeOnExecutor, rejecting execution", e);
        }
    }
}
