...
public class PhoneStatusBarView extends PanelBar {
    ...
    /// M: Use HW layer to speed up tracking performance of notification panel
    @Override 
    public void onTrackingStarted(PanelView panel) {
        super.onTrackingStarted(panel);
        mBar.setLayers(View.LAYER_TYPE_HARDWARE);
        if (mNotificationPanel != null) mNotificationPanel.setLayers(View.LAYER_TYPE_HARDWARE);
        if (mSettingsPanel != null) mSettingsPanel.setLayers(View.LAYER_TYPE_HARDWARE);
    }
    
    private void resetLayers() {
        mBar.setLayers(View.LAYER_TYPE_NONE);
        if (mNotificationPanel != null) mNotificationPanel.setLayers(View.LAYER_TYPE_NONE);
        if (mSettingsPanel != null) mSettingsPanel.setLayers(View.LAYER_TYPE_NONE);
    }
}
