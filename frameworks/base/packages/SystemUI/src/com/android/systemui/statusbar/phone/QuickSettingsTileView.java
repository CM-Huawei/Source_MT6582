...
public class QuickSettingsTileView extends FrameLayout {
    ...
    /// M: added for plugin tile id
    static final boolean DEBUG_GONE_TILES = false;
	  private QuickSettingsTileViewId mTileViewId;
    ...
    void setContent(int layoutId, LayoutInflater inflater) {
        setContent(layoutId, inflater, QuickSettingsTileViewId.ID_UNKNOWN);
    }

    public void setContent(int layoutId, LayoutInflater inflater, QuickSettingsTileViewId id) {
    ...
    /// M: added for plugin tile id
    public void setTileViewId(QuickSettingsTileViewId id) {
        mTileViewId = id;
    }

    public QuickSettingsTileViewId getTileViewId(){
        return mTileViewId;
    }
}