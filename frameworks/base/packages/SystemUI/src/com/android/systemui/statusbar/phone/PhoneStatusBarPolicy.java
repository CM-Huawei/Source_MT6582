...
public class PhoneStatusBarPolicy {
    ...
    private final void updateBluetooth(Intent intent) {
        Log.v(TAG, "updateBluetooth: begin");
        ...
        if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
            ...
            Log.v(TAG, "BluetoothAdapter.ACTION_STATE_CHANGED, state = " + state);
            ...
            Log.v(TAG, "BluetoothAdapter.ACTION_CONNECTION_STATE_CHANGED, state = " + state);
        } else {
            return;
        }

        Log.v(TAG, "updateBluetoothe,  mBluetoothEnabled = " + mBluetoothEnabled);

        mService.setIcon("bluetooth", iconId, 0, contentDescription);
        mService.setIconVisibility("bluetooth", mBluetoothEnabled);

        Log.v(TAG, "updateBluetooth: end");
    }
