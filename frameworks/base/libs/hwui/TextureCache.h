...
private:
    ...
    void uploadLoFiTexture(GLint id, bool resize, SkBitmap* bitmap, uint32_t width, uint32_t height);
    void uploadToTexture(GLint id, bool resize, GLenum format, GLsizei stride,
