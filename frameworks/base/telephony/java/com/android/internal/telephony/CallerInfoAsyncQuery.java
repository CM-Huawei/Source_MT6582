...
public class CallerInfoAsyncQuery {
                ...
                if (cw.event == EVENT_EMERGENCY_NUMBER) {
                    ...
                    if (FeatureOption.MTK_GEMINI_SUPPORT) {
                       ...
                       try {
                           ...
                           phoneType = iTel.getActivePhoneTypeGemini(cw.simId);
                       } catch (Exception e) {
                       }
    ...
    public static CallerInfoAsyncQuery startQuery(int token, Context context, String number,
        ...
        int simId = SystemProperties.getInt(
                ...
                GEMINI_SIM_1);
        return startQueryEx(token, context, number, listener, cookie, simId);
    ...
    public static CallerInfoAsyncQuery startQueryEx(int token, Context context, String number,
        ...
        /* To solve ALPS01273023, ignore voice mail number checking if it is SIP call */
