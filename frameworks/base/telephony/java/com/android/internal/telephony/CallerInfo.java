...
*/
    ...
    public static CallerInfo getCallerInfo(Context context, String number) {
        ...
        int simId = SystemProperties.getInt(
                ...
                GEMINI_SIM_1);
        return getCallerInfoEx(context, number, simId);
     ...
     * @internal
     */
    public static CallerInfo getCallerInfoEx(Context context, String number, int simId) {
        if (TextUtils.isEmpty(number)) {
            return null;
        }

        Rlog.d(TAG, "number " + number + " simId: " + simId);
