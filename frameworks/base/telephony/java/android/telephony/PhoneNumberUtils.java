...
public class PhoneNumberUtils
{
    ...
    isNonSeparator(char c) {
        if (true == mPhoneNumberExt.isPauseOrWait(c)) {
            return true;
        }
        return (c >= '0' && c <= '9') || c == '*' || c == '#' || c == '+'
    ...
    compareLoosely(String a, String b) {
        ...
        if (MTK_CTA_SUPPORT_FLAG) {
            ...
            minMatchLen = mPhoneNumberExt.getMinMatch();;
        }
    ...
    public static boolean isEmergencyNumber(String number) {
        ...
        if (FeatureOption.MTK_CTA_SET) {
            ...
            for (String emergencyNum : emergencyCTAList) {
                ...
                if (emergencyNum.equals(number)
                    ...
                    Rlog.d(LOG_TAG, "[isEmergencyNumber] CTA list: " + "return true");
                    return true;
                }
            }
        }
        ...
        if (!TextUtils.isEmpty(numbers)) {
            ...
            for (String emergencyNum : numbers.split(",")) {
                ...
                if (emergencyNum.equals(number)
                     || numberPlus.equals(number)) {
                    Rlog.d(LOG_TAG, "[isEmergencyNumber] ril.ecclist: " + "return true");
                    return true;
                }
            }
            bSIMInserted = true;
        ...
        if (!TextUtils.isEmpty(numbers)) {
            ...
            for (String emergencyNum : numbers.split(",")) {
                ...
                if (emergencyNum.equals(number)
                     || numberPlus.equals(number)) {
                    Rlog.d(LOG_TAG, "[isEmergencyNumber] ril.ecclist2: " + "return true");
                    return true;
                }
            }
            bSIMInserted = true;
        ...
        if (!TextUtils.isEmpty(numbers)) {
            ...
            for (String emergencyNum : numbers.split(",")) {
                ...
                if (emergencyNum.equals(number)
                     || numberPlus.equals(number)) {
                    Rlog.d(LOG_TAG, "[isEmergencyNumber] ril.ecclist3: " + "return true");
                    return true;
                }
            }
            bSIMInserted = true;
        ...
        if (!TextUtils.isEmpty(numbers)) {
            ...
            for (String emergencyNum : numbers.split(",")) {
                ...
                if (emergencyNum.equals(number)
                     || numberPlus.equals(number)) {
                    Rlog.d(LOG_TAG, "[isEmergencyNumber] ril.ecclist4: " + "return true");
                    return true;
                }
            }
            bSIMInserted = true;
        ...
        if (bSIMInserted) {
            // Customized ecc number when SIM inserted
            ...
            if (FeatureOption.EVDO_DT_SUPPORT && FeatureOption.EVDO_DT_VIA_SUPPORT) {
                String [] emergencyNumList_cdma = {"112", "911", "000", "08", "110", "118", "119", "999","120","122"};
            ...
            for (int i = 0; i < eccNo; i++) {
                ...
                if (emergencyNumList[i].equals(number)
                    || numberPlus.equals(number)) {
                    Rlog.d(LOG_TAG, "[isEmergencyNumber] no sim ecclist: " + "return true");
                    return true;
                }
            }
        ...
        if (FeatureOption.MTK_CTA_SET) {
            ...
            for (String emergencyNum : emergencyCTAList) {
                ...
                if (emergencyNum.equals(dialString)
                    ...
                    Rlog.d(LOG_TAG, "[isSpecialEmergencyNumber] CTA list: " + "return true");
                    return true;
                }
            }
        }
