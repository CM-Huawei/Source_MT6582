        ...
        M4OSA_UInt32 dx, M4OSA_UInt32 dy)
{
    ...
    M4OSA_TRACE1_5("videoBrowserSetWindow: entering with 0x%x %d %d %d %d ",
            pContext, x, y, dx, dy);
...
videoBrowserCreate_cleanUp:
    ...
    M4OSA_TRACE1_1("videoBrowserCreate returned 0x%x", err);
    return err;
}
...
videoBrowserCleanUp_cleanUp:
    ...
    M4OSA_TRACE1_1("videoBrowserCleanUp returned 0x%x", err);
    return err;
}
/******************************************************************************
    ...
    M4OSA_UInt32 tolerance)
{
    ...
    M4OSA_TRACE1_3("videoBrowserPrepareFrame: timeMS: %f, targetTime: %d, tolerance %d ",
                timeMS, targetTime, tolerance);
...
videoBrowserPrepareFrame_cleanUp:
    ...
    M4OSA_TRACE1_1("videoBrowserPrepareFrame returned 0x%x", err);
    return err;
}
...
videoBrowserDisplayCurrentFrame_cleanUp:
    ...
    M4OSA_TRACE1_1("videoBrowserDisplayCurrentFrame returned 0x%x", err) ;
    return err;
}
