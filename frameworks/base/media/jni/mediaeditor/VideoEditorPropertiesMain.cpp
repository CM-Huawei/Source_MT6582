        ...
        jstring file)
{
    ...
    if (gotten)
    {
...
#ifndef ANDROID_DEFAULT_CODE            //update real audio duration here CR583138
                pProperties->uiClipAudioRealDuration = pClipProperties->uiClipAudioDuration;
            ...
            (VideoEditClasses_kFileType_PNG == fileType))
        {
            ...
            pProperties->uiClipAudioRealDuration = 0;
#endif //ANDROID_DEFAULT_CODE
...
#ifndef ANDROID_DEFAULT_CODE //
    if (channelsupport == false)
    {
        ALOGD("multi channel not suport");    
        return M4OSA_NULL;
    }
#endif	
