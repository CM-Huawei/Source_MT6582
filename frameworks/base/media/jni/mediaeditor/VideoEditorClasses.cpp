...
VIDEOEDIT_JAVA_DEFINE_FIELDS(Properties)
{
    ...
    VIDEOEDIT_JAVA_FIELD_INIT("audioRealDuration",      "I"),
...
#ifndef ANDROID_DEFAULT_CODE //CR583138
            // Set the audioRealDuration field.
            pEnv->SetIntField(object, fieldIds.audioRealDuration, pProperties->uiClipAudioRealDuration);
#endif //ANDROID_DEFAULT_CODE
...
#ifndef ANDROID_DEFAULT_CODE //CR583138
        VIDEOEDIT_LOG_SETTING(ANDROID_LOG_INFO, "VIDEO_EDITOR_PROP_CLASSES",
            "%*c uiClipAudioRealDuration:          %u",       indentation, ' ',
            (unsigned int)pProperties->uiClipAudioRealDuration);
#endif //ANDROID_DEFAULT_CODE
