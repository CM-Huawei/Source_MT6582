...
public class MediaScanner
{
    ...
    private class MyMediaScannerClient implements MediaScannerClient {
        ...
        /// M: add for file genarated by N3D
...
//            long t1 = System.currentTimeMillis();
            try {
                ...
                Xlog.e(TAG, "RemoteException in MediaScanner.scanFile()", e);
            }
//            long t2 = System.currentTimeMillis();
//            Xlog.v(TAG, "scanFile: " + path + " took " + (t2-t1));
            return result;
        }
        ...
        public void handleStringTag(String name, String value) {
            ...
            /// @}
            } else if (name.equalsIgnoreCase("is_mtk_3d")) {
                mIsMtk3d = (parseSubstring(value, 0, 0) == 1);
                ...
                mSlowMotionSpeed = parseSubstring(value, 0, 0);
            } else {
                //Xlog.v(TAG, "unknown tag: " + name + " (" + mProcessGenres + ")");
            }
        }
        ...
        private boolean convertGenreCode(String input, String expected) {
            ...
            if (output.equals(expected)) {
                ...
                Xlog.d(TAG, "'" + input + "' -> '" + output + "', expected '" + expected + "'");
                return false;
            }
        }
        ...
        private ContentValues toValues() {
            ...
            if (!mNoMedia) {
                if (MediaFile.isVideoFileType(mFileType)) {
                    ...
                    /// M: Add for s3d and live photo @{
                    map.put(Video.Media.STEREO_TYPE, mStereoType);
                    map.put(Video.Media.IS_MTK_3D, mIsMtk3d);
            ...
            if (MediaFile.isAudioFileType(mFileType) && (rowId == 0 || mMtpObjectHandle != 0)) {
                ...
                if (exif != null) {
                    ...
                    try {
                        ...
                        Xlog.e(TAG, "endFile: " + groupIdStr + " cannot be converted to long.");
                    }
                   ...
                   // long focusValue = (focusHigh<<32) + focusLow;
                ...
                if (mFileType == MediaFile.FILE_TYPE_MPO) {
                    ...
                    try {
                        mpoDecoder = MediatekClassFactory.createInstance(
                                IMpoDecoder.class, entry.mPath);
                    } catch (RuntimeException e) {
                        /// create MPO decoder failed, maybe the mpo file is error file.
                    }
                ...
                } else if (mFileType == MediaFile.FILE_TYPE_JPS) {
                    IJpsParser parser = null;
                    try {
                        parser = MediatekClassFactory.createInstance(IJpsParser.class, new File(entry.mPath));
                    } catch (RuntimeException e) {
                        /// create JPS parser failed, maybe the jps file is error file.
                    }
                    if (parser != null) {
                        ...
                        mIsMtk3d = parser.isMtk3d();
                        values.put(Images.Media.IS_MTK_3D, mIsMtk3d);
                    } else {
    ...
    private void pruneDeadThumbnailFiles() {
        ...
        try {
            c = mMediaProvider.query(
                    ...
                    null,
                    null, null);
            Xlog.v(TAG, "pruneDeadThumbnailFiles... " + c);
            if (null != c) {
            ...
            for (String fileToDelete : existingFiles) {
                if (true)
                    Xlog.v(TAG, "fileToDelete is " + fileToDelete);
                try {
    ...
    public void scanDirectories(String[] directories, String volumeName) {
        try {
            ...
            if (true) {
                Xlog.d(TAG, " prescan time: " + (prescan - start) + "ms\n");
                Xlog.d(TAG, "    scan time: " + (scan - prescan) + "ms\n");
                Xlog.d(TAG, "postscan time: " + (end - scan) + "ms\n");
                Xlog.d(TAG, "   total time: " + (end - start) + "ms\n");
            }
        } catch (SQLException e) {
            // this might happen if the SD card is removed while the media scanner is running
            Xlog.e(TAG, "SQLException in MediaScanner.scan()", e);
        } catch (UnsupportedOperationException e) {
            // this might happen if the SD card is removed while the media scanner is running
            Xlog.e(TAG, "UnsupportedOperationException in MediaScanner.scan()", e);
        } catch (RemoteException e) {
            Xlog.e(TAG, "RemoteException in MediaScanner.scan()", e);
        }
    }
    ...
    public void scanMtpFile(String path, String volumeName, int objectHandle, int format) {
        ...
        if (!MediaFile.isAudioFileType(fileType) && !MediaFile.isVideoFileType(fileType) &&
            ...
            // ALPS00670132, for WHQL ObjectSize folder case
            ...
            try {
                ...
                Xlog.e(TAG, "RemoteException in scanMtpFile", e);
            }
            return;
        }
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (entry.bestmatchlevel > 0) {
                try {
                    ...
                    Xlog.e(TAG, "RemoteException in MediaScanner.processCachedPlaylist()", e);
                    return;
                }
            }
        }
    ...
    private void processM3uPlayList(String path, String playListDirectory, Uri uri,
        ...
        try {
            ...
            Xlog.e(TAG, "IOException in MediaScanner.processM3uPlayList()", e);
        } finally {
            try {
                if (reader != null)
                    reader.close();
    ...
    private void processPlsPlayList(String path, String playListDirectory, Uri uri,
        ...
        try {
            ...
            Xlog.e(TAG, "IOException in MediaScanner.processPlsPlayList()", e);
        } finally {
            try {
                if (reader != null)
                    reader.close();
    ...
    public ArrayList<String> scanFolders(String[] folders, String volume, boolean isSingelFileOrEmptyFolder) {
        try {
            ...
            /// M: Call doScanFile to scan single file and empty folder and use processDirecitory to scan folders.
