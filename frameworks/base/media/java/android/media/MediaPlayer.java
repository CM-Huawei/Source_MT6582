...
public class MediaPlayer implements SubtitleController.Listener
{
    ...
    /// M: add lock protect for cts multi-thread case(ALPS01357222) @{
    ...
    private static final String MEDIA_MIMETYPE_TEXT_SUBASS = "application/x-subtitle-ass";
    private static final String MEDIA_MIMETYPE_TEXT_SUBSSA = "application/x-subtitle-ssa";
    private static final String MEDIA_MIMETYPE_TEXT_SUBTXT = "application/x-subtitle-txt";
    private static final String MEDIA_MIMETYPE_TEXT_SUBMPL = "application/x-subtitle-mpl";
    private static final String MEDIA_MIMETYPE_TEXT_SUBSMI = "application/x-subtitle-smi";
    private static final String MEDIA_MIMETYPE_TEXT_SUB = "application/x-subtitle-sub";
    private static final String MEDIA_MIMETYPE_TEXT_IDX = "application/x-subtitle-idx";
    ///@}
    ...
    private static boolean availableMimeTypeForExternalSource(String mimeType) {
        ...
        ///M: Add for MTK_SUBTITLE_SUPPORT @{
        if (FeatureOption.MTK_SUBTITLE_SUPPORT) {
    ...
    public void addTimedTextSource(String path, String mimeType)
        ...
        if (file.exists()) {
            ///M: Add for MTK_SUBTITLE_SUPPORT @{
            if(FeatureOption.MTK_SUBTITLE_SUPPORT && mimeType == MEDIA_MIMETYPE_TEXT_IDX) {
                Parcel request = Parcel.obtain();
                Parcel reply = Parcel.obtain();
                try {
    ...
    private class EventHandler extends Handler
    {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_SKIPPED:
              /// M: add lock protect for cts multi-thread case(ALPS01414241) @{
	      synchronized(mTimeProviderLock) {
                if (mTimeProvider != null) {
