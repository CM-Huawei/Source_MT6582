...
public class MediaProperties {
    ...
    private static final Pair<Integer, Integer>[] ASPECT_RATIO_3_2_RESOLUTIONS =
        new Pair[] {
        /// M: For H264 must 16 multiple width change 720->736
        new Pair<Integer, Integer>(736, HEIGHT_480),
        new Pair<Integer, Integer>(1088, HEIGHT_720)
    };

    @SuppressWarnings({"unchecked"})
    private static final Pair<Integer, Integer>[] ASPECT_RATIO_4_3_RESOLUTIONS =
        new Pair[] {
        /// M: For H264 must 16 multiple width, come from 11:9 176*144
        new Pair<Integer, Integer>(192, HEIGHT_144),
    ...
    private static final Pair<Integer, Integer>[] ASPECT_RATIO_11_9_RESOLUTIONS =
        new Pair[] {
        /// M: for H264 must 16 multiple width, 176 to 192, so move to 4:3
    ...
    private static final Pair<Integer, Integer>[] ASPECT_RATIO_16_9_RESOLUTIONS =
        new Pair[] {
        /// M: for H264 must 16 multiple width change 848->864
        new Pair<Integer, Integer>(864, HEIGHT_480),
