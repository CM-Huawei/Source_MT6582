...
public final class ActiveServices {
    ...
    static boolean DEBUG_DELAYED_STATS = DEBUG_DELAYED_SERVICE;
    ...
    void serviceTimeout(ProcessRecord proc) {
        ...
        synchronized(mAm) {     /// M: fix [google issue] wrong lock, this => mAm
    ...
    void scheduleServiceTimeoutLocked(ProcessRecord proc) {
        ...
        /// @}
        /// M: Update CPU usage when predump @{
