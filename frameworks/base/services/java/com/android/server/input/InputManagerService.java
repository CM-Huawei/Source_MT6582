...
public class InputManagerService extends IInputManager.Stub
    ...
    private static native void nativeSetSmartBookPlugIn(int ptr, boolean plugin);
    ...
    private static native void nativeSetPointerPrimaryKey(int ptr, boolean changePrimaryKey);
