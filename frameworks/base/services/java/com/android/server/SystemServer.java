...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        SDIOAutoKService sdioAutoK = null;
        ...
        try {
            ...
            if (true == FeatureOption.MTK_SDIOAUTOK_SUPPORT) {
                Slog.i(TAG, "SDIO Auto-K Service");
                sdioAutoK = new SDIOAutoKService(context);
                ServiceManager.addService("sdioAutoK", sdioAutoK);
            }
