...
final class DisplayPowerRequest {
    ...
    /// MTK: Proximity sensor @{
    // Proximity sensor force enable only for talking scenario
    public boolean forceProximitySensorEnable;
    public boolean forceWakeUpEnable;
    ///@}
    ...
    public DisplayPowerRequest() {
        ...
        /// MTK: Proximity sensor @{
        forceProximitySensorEnable = false;
        forceWakeUpEnable = false;
        ///@}
    ...
    public void copyFrom(DisplayPowerRequest other) {
        ...
        /// MTK: Proximity sensor @{
        forceProximitySensorEnable = other.forceProximitySensorEnable;
        forceWakeUpEnable = other.forceWakeUpEnable;
        ///@}
    ...
    public String toString() {
        return "screenState=" + screenState
                ...
                + ", forceProximitySensorEnable=" + forceProximitySensorEnable
                + ", forceWakeUpEnable=" + forceWakeUpEnable
