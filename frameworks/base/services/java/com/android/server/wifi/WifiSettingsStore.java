...
final class WifiSettingsStore {
    ...
    synchronized boolean handleAirplaneModeToggled(boolean isAirplaneModeOn) {
...
//        mAirplaneModeOn = getPersistedAirplaneModeOn();
        ...
        SXlog.d(TAG, "Received ACTION_AIRPLANE_MODE_CHANGED, mAirplaneModeOn:" + mAirplaneModeOn);
        if (mAirplaneModeOn) {
