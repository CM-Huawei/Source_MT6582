...
public class DimLayer {
    ...
    void show(int layer, float alpha, long duration) {
        ...
        if (mStack.hasSibling()) {
            ...
            // corner.
            /// M:[ALPS00749460]The landscape mode will show as a abnormal page
            final int dmax = info.logicalWidth > info.logicalHeight ? info.logicalWidth : info.logicalHeight;
            dw = (int) (dmax * 1.5);
            dh = (int) (dmax * 1.5);
        ...
        if (!mLastBounds.equals(mBounds) || mLayer != layer) {
            try {
                ...
                /// M: [ALPS01414982] Avoid setSize() if doesn't change
                if (dw != mLastBounds.width() || dh != mLastBounds.height()) {
            ...
            /// M: [ALPS01414982] Avoid setSize() if doesn't change
            mLastBounds.set((int)xPos, (int)yPos, (int)xPos + dw, (int)yPos + dh);
            mLayer = layer;
        }
