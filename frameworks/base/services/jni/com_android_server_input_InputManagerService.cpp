...
void NativeInputManager::setSmartBookPlugIn(bool plugin) {
    ...
    ALOGD("setSmartBookPlugIn : %s", plugin ? "true" : "false");
}
...
bool NativeInputManager::isSbScreenOn() {
    return android_server_PowerManagerService_isSbScreenOn();
}
...
static void nativeSetSmartBookPlugIn(JNIEnv* env,
        jclass clazz, jint ptr, jboolean plugin) {
    NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
...
static void nativeSetPointerPrimaryKey(JNIEnv* env,
        jclass clazz, jint ptr, jboolean changePrimaryKey) {
    NativeInputManager* im = reinterpret_cast<NativeInputManager*>(ptr);
...
static JNINativeMethod gInputManagerMethods[] = {
    ...
    { "nativeSetPointerPrimaryKey", "(IZ)V",
