        ...
        public void onUEvent(UEventObserver.UEvent event) {
            if (FeatureOption.MTK_SMARTBOOK_SUPPORT && mHDMI != null) {
                ...
                if (1 == type || mSmartBookPlugIn) { //SmartBook HDMI plug
                    try {
                        mWindowManager.notifySmartBookState("1".equals(event.get("SWITCH_STATE")));
            ...
            if ((fl & (FLAG_LAYOUT_IN_SCREEN | FLAG_LAYOUT_INSET_DECOR))
                ...
                if (attached != null) {
                    ...
                    if ((fl & FLAG_FULLSCREEN) == 0) {
                        ...
                        if (mfindingTopFullscreenOpaque && !mLayoutDisableStatusBar) {
        ...
        if (mTopFullscreenOpaqueWindowState == null &&
            ...
            if (applyWindow
                ...
                if ((attrs.flags & FLAG_DISMISS_KEYGUARD) != 0
                    ...
                    /// M: [ALPS00484759] Handle switch Keyguard secure mode when dismissing @{
                    final boolean isSecure = mKeyguardDelegate != null ? mKeyguardDelegate.isSecure() : false;
        ...
        if ((isScreenOn && !mHeadless) || (isInjected && !isWakeKey)) {
            ...
            if (down && isWakeKey && isWakeKeyWhenScreenOff(keyCode)) {
                ...
                if (monitorHandler != null) {
                    if (monitorHandler.hasMessages(MessageMonitorLogger.START_MONITOR_EXECUTION_TIMEOUT_MSG, monitorHandler)) {
                    ...
                    if (!isScreenOn) {
                        ...
                        Message msg = monitorHandler.obtainMessage(MessageMonitorLogger.START_MONITOR_EXECUTION_TIMEOUT_MSG, monitorHandler);
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_MUTE: {
                if (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN) {
                    ...
                    if(  (false == ("user".equals(Build.TYPE) || "userdebug".equals(Build.TYPE)))&& SystemProperties.get("persist.sys.anr_sys_key").equals("1")) {
   ...
   ///@}
    ...
    private void waitForKeyguardWindowDrawn(IBinder windowToken,
        ...
        if (windowToken != null && !mHideLockScreen) {
            ...
            /// M:ALPS01290677: Avoid JE if user immediately finish activity after screen on
    ...
    private int updateSystemBarsLw(WindowState win, int oldVis, int vis) {
        ...
        // M: [ALPS01259584] Update status bar by top window when Keyguard animating.
        WindowState transWin = mKeyguard != null && (mKeyguard.isVisibleLw() && !mKeyguard.isAnimatingLw()) && !mHideLockScreen
                ? mKeyguard
                : mTopFullscreenOpaqueWindowState;
