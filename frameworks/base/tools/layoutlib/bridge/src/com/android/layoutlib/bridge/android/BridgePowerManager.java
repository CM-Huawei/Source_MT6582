...
public class BridgePowerManager implements IPowerManager {
    ...
    @Override
    public void sbGoToSleep(long arg0, int arg1) throws RemoteException {
        // pass for now.
    }
    ...
    @Override
    public void sbWakeUp(long time) throws RemoteException {
        // pass for now.
    }

    @Override
    public void sbScreenOnCtrl(int timeout) throws RemoteException {
        // pass for now.
    }

    @Override
    public void sbScreenOffCtrl(int timeout) throws RemoteException {
        // pass for now.
    }
}
