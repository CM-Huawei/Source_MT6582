...
enum camcorder_quality {
    ...
    //slow motion
    CAMCORDER_QUALITY_MTK_SLOW_MOTION_LIST_START    = 19,
    CAMCORDER_QUALITY_MTK_SLOW_MOTION_LOW           = 19,
    CAMCORDER_QUALITY_MTK_SLOW_MOTION_MEDIUM        = 20,
    CAMCORDER_QUALITY_MTK_SLOW_MOTION_HIGH          = 21,
    CAMCORDER_QUALITY_MTK_SLOW_MOTION_FINE          = 22,
    CAMCORDER_QUALITY_MTK_SLOW_MOTION_LIST_END      = 22,

    CAMCORDER_QUALITY_LIST_END             = 22,        //this value should be equal to the last one enum definition
...
#else//not MTK_VIDEO_PROFILE && ANDROID_DEFAULT_CODE
