...
static MediaBuffer* readBufferFromReader(
...
#ifndef ANDROID_DEFAULT_CODE
    Mutex::Autolock autolock(pDecContext->mLock);
#endif  //ANDROID_DEFAULT_CODE
    M4OSA_ERR lerr = M4NO_ERROR;
    M4_AccessUnit* pAccessUnit = pDecContext->m_pNextAccessUnitToDecode;
    ALOGD("readBufferFromReader in %x %x  %x", pDecContext, pDecContext->m_pReader, pDecContext->m_pReader->m_readerContext);
    ...
    ALOGD("readBufferFromReader m_size %d", pAccessUnit->m_size);
