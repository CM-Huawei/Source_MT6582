...
#ifndef ANDROID_DEFAULT_CODE
        // M4VSS3GP_EditAudio Read/Write mode reset 3gp reader, and reader CTS go back
        // avoid CTS inverse since 3gp reader reset is not easy to handle CTS inverse issue.
        
        if ((M4MP4W_Time32)auPtr->CTS < mMp4FileDataPtr->audioTrackPtr->CommonData.lastCTS)
        {
            auPtr->CTS  =  mMp4FileDataPtr->audioTrackPtr->CommonData.lastCTS;
        }
