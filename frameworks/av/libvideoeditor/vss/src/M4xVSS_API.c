...
#ifndef ANDROID_DEFAULT_CODE
            else if( fileProperties.uiVideoWidth == 192
#else
...
#ifndef ANDROID_DEFAULT_CODE
                /* Rotation has been done in the transcoded 3GP file. */
                xVSS_context->pSettings->pClipList[i]->ClipProperties.videoRotationDegrees = 0;
#endif
            }
            else
            {
