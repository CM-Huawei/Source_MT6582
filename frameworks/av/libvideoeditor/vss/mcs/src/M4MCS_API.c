...
#ifndef ANDROID_DEFAULT_CODE
            M4OSA_TRACE2_2(
                "M4MCS_intAudioNullEncoding(): m_CTS ReaderAudioAU2 %f, ReaderAudioAU1 %f ", pC->ReaderAudioAU2.m_CTS, pC->ReaderAudioAU1.m_CTS);
#endif //ANDROID_DEFAULT_CODE
...
#ifndef ANDROID_DEFAULT_CODE
    M4OSA_TRACE2_3("M4MCS_intAudioNullEncoding(): audio AU: CTS=%f ms, %d, %d",
        pC->ReaderAudioAU.m_CTS, pC->iAudioCtsOffset, pC->WriterAudioStream.timeScale);
#endif //ANDROID_DEFAULT_CODE
...
#ifndef ANDROID_DEFAULT_CODE
    if( pC->WriterAudioAU.CTS < 0 )
    {
        M4OSA_TRACE1_3("@@ M4MCS_intAudioNullEncoding ReaderAudioAU.CTS: %f < iAudioCtsOffset: %d, timeScalet: %d ", pC->ReaderAudioAU.m_CTS, pC->iAudioCtsOffset, pC->WriterAudioStream.timeScale );
        pC->WriterAudioAU.CTS = 0;
    }
#endif
...
#ifndef ANDROID_DEFAULT_CODE
            if( pC->WriterVideoAU.CTS < 0 )
            {
                M4OSA_TRACE1_3("@@ M4MCS_intVideoNullEncoding ReaderVideoAU.CTS: %f < iAudioCtsOffset: %d, timeScale: s%d ", pC->ReaderVideoAU.m_CTS, pC->iAudioCtsOffset, pC->WriterVideoStream.timeScale );
                pC->WriterVideoAU.CTS = 0;
            }
#endif
        /**
        * Write it to the output file */
