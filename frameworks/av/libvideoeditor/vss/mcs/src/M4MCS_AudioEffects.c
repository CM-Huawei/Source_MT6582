...
#define LOG_TAG "M4MCS_AUDIOEFFECTS"
#include <utils/Log.h>
#endif
/****************/
/*** Includes ***/
...
#ifndef	ANDROID_DEFAULT_CODE
	if(pC->dAuDecCurrentCts > pC->uiBeginCutTime && pC->dAuDecCurrentCts < pC->uiEndCutTime)
...
#ifndef	ANDROID_DEFAULT_CODE
        outputRelatedTime =
		(M4OSA_UInt32)(pC->dAuDecCurrentCts	- pC->uiBeginCutTime + 0.5);
#else
        outputRelatedTime =
