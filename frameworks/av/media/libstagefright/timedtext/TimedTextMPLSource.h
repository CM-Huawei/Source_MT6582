...
#ifndef TIMED_TEXT_MPL_SOURCE_H_
#define TIMED_TEXT_MPL_SOURCE_H_
...
class TimedTextMPLSource : public TimedTextSource {
public:
	TimedTextMPLSource(const sp<DataSource>& dataSource);
...
private:
	...
	DISALLOW_EVIL_CONSTRUCTORS(TimedTextMPLSource);
};
};
