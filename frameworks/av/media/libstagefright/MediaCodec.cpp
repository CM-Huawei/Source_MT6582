...
void MediaCodec::onMessageReceived(const sp<AMessage> &msg) {
	...
	ALOGI("[%s][msg='%s' ][what=kWhatBuffersAllocated]:IN",__FUNCTION__,msg->debugString().c_str());
                ...
                {
                    ALOGI("codec output format changed");
                    ...
                    {
                        int32_t mColorFormat = OMX_COLOR_FormatYUV420Planar;
                        msg->findInt32("color-format", &mColorFormat);
                        if( OMX_COLOR_FormatYUV420Planar != mColorFormat )
                        {
                            // In CTS EncodeDecodeTest.java,
                            ...
                            //ALOGE("Redefine output format from %x to %x", mColorFormat, OMX_COLOR_FormatYUV420Planar);
                            //msg->setInt32("color-format", OMX_COLOR_FormatYUV420Planar);
                        }
                    }
#endif
#endif //ANDROID_DEFAULT_CODE
