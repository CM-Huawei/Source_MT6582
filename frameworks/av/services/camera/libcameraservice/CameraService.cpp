...
//!++
    ...
    CFPT::AutoLog _cptlog(Event_CS_connect);
//!--
...
status_t CameraService::connectFinishUnsafe(const sp<BasicClient>& client,
                                            const sp<IBinder>& remoteCallback) {
//!++
    CFPT::AutoLog _cptlog(Event_CS_connectFinishUnsafe);
//!--
...
//!++
    CFPT::AutoLog _cptlog(Event_CS_newMediaPlayer);
...
//!++
    CFPT::AutoLog _cptlog(Event_CS_playSound);
//!--
...
{
//!++
     CFPT::AutoLog _cptlog(Event_CS_Client_Ctor);
//!--
    int callingPid = getCallingPid();
