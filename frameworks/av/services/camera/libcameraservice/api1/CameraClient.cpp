...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_disconnectWindow);
//!--
    if (window != 0) {
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_disconnect);
//!--
    int callingPid = getCallingPid();
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_setPreviewWindow);
//!--
    Mutex::Autolock lock(mLock);
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_startPreview);
//!--
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_startRecording);
//!--
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_stopPreview);
//!--
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_stopRecording);
//!--
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_releaseRecordingFrame);
//!--
//!++
#if 1   // defined(MTK_CAMERA_BSP_SUPPORT)
    ssize_t offset;
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_takePicture);
//!--
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_setParameters);
//!--
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_getParameters);
//!--
    Mutex::Autolock lock(mLock);
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_sendCommand);
//!--
...
//!++
    CFPT::AutoLog _cptlog(Event_C1C_dataCallbackTimestamp);
//!--
