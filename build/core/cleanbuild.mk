...
#
installclean_files := \
	$(TARGET_OUT_ROOT)/frameworks \
	$(TARGET_OUT_ROOT)/hardware \
	$(TARGET_OUT_ROOT)/mediatek \
	$(TARGET_PRODUCT_OUT_ROOT)/Common \
	$(TARGET_PRODUCT_OUT_ROOT)/frameworks \
	$(TARGET_PRODUCT_OUT_ROOT)/mediatek \
