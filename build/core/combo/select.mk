...
ifneq ($(USE_DXCACHE),)
  export DXCACHE_COMPILERCHECK := content
  export DXCACHE_SLOPPINESS := time_macros,include_file_mtime,file_macro
  ifndef dxcache
    dxcache := prebuilts/misc/$(HOST_PREBUILT_TAG)/dxcache/dxcache
  endif
  dxcache := $(strip $(wildcard $(dxcache)))
endif
